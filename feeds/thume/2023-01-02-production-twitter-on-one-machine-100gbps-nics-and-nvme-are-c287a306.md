...
feed: thume
guid: https://thume.ca/2023/01/02/one-machine-twitter
---
...
Given those numbers, I’ll be using the “ [your dataset fits in RAM](https://twitter.com/garybernhardt/status/600783770925420546?s=20)” paradigm of systems design. However it’s a little more complicated since our dataset doesn’t *actually* fit in RAM.
...
BERT is a popular sentence embedding model and clever people have managed to [distill it at the same performance into a tiny model](https://arxiv.org/abs/1909.10351). Let’s assume we base our ML on those models running in bf16:
...
![Pipeline diagram](/assets/postassets/twitterperf/pipeline.png)
