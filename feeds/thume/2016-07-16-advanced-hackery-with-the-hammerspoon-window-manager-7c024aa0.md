...
url: https://thume.ca/2016/07/16/advanced-hackery-with-the-hammerspoon-window-manager/
published: "2016-07-16T00:00:00Z"
feed: thume
guid: https://thume.ca/2016/07/16/advanced-hackery-with-the-hammerspoon-window-manager
---
...
![Hints Screenshot](/assets/postassets/hammerspoon/hammerspoon.png)
...
[The module](https://github.com/trishume/mjolnir.th.hints) was written mostly in a single evening as a native Lua module (originally for Mjolnir, the precursor to Hammerspoon). It didn’t take much time, and is very enjoyable to use, and because the module was added to the core Hammerspoon distribution, lots of other people can also benefit from it.
...
![Tabs Screenshot](/assets/postassets/hammerspoon/tabs.png)
...
![Lookmouse](/assets/postassets/hammerspoon/lookmouse.jpg)
