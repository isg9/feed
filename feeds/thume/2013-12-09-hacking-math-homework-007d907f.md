...
url: https://thume.ca/2013/12/09/math-summative-program/
published: "2013-12-09T00:00:00Z"
feed: thume
guid: https://thume.ca/2013/12/09/math-summative-program
---

# Hacking Math Homework

Many high school students complain about boring and repetitive homework, but I’ve found a fun way of dealing with this that I find actually helps me understand concepts even better. When faced with large rote assignments I write programs to complete the homework like no human can: instantly, perfectly and on a large scale. In the past I have written written [Literary Analysis Visualizations](/2013/01/24/hacking-english-class/), Punnet Square generators and [Graphing Programs](http://github.com/trishume/handyGraph).
...
![Obama](/assets/postassets/mathSummative/obama_small.png)[![Function Collage](/assets/postassets/mathSummative/collage_small.png)](/assets/postassets/mathSummative/collage_small.png)

## Additional Resources

Another part of the program outputs a massive Latex document with all the large piecewise functions that produces a huge PDF. You can [download a PDF](/assets/postassets/mathSummative/summative.pdf) that explains all the parts and has some more examples.
