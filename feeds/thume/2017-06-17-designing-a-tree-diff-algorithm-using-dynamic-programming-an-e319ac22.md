...
![Decision tree diagram](/assets/postassets/treediff/tree.png)
...
![Decision tree diagram rotated to be a grid](/assets/postassets/treediff/treegrid.png)
...
![Levenshtein distance paths](/assets/postassets/treediff/simplepaths.png)
...
[![Tree diff diagram](/assets/postassets/treediff/treediffgrid.png)](/assets/postassets/treediff/treediffgrid.pdf)
...
![Heuristic diagram](/assets/postassets/treediff/heuristic.png)
...
1. A great place to work, highly recommend. I did get Jane Street’s permission before divulging the algorithm I wrote for them in this post. [↩](#fnref:1)
