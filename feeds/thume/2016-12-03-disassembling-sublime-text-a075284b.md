...
url: https://thume.ca/2016/12/03/disassembling-sublime-text/
published: "2016-12-03T00:00:00Z"
feed: thume
guid: https://thume.ca/2016/12/03/disassembling-sublime-text
---

# Disassembling Sublime Text

This afternoon I spent some time with the free trial of the [Hopper Disassembler](https://www.hopperapp.com/) looking through the binary of Sublime Text 3. I found some interesting things and some undocumented settings.
...
![Debug rendering mode](/assets/postassets/sublimesecrets/debug_render.png)![Debug rendering mode](/assets/postassets/sublimesecrets/configs.png)
...
If there’s anything you’re interested in about Sublime Text’s internals, leave a comment and I might take a look. Especially if it’s a tiny behaviour improvement that isn’t accessible to the plugin API but might be possible to patch in the binary, with a debugger, or with something like [Frida](http://www.frida.re/).

## Edit: Updates

After this article was posted on [Hacker News](https://news.ycombinator.com/item?id=13100560) and cross-posted to [the Sublime forum](https://forum.sublimetext.com/t/disassembling-sublime-text/24824), @wbond, the Package Control maintainer and new Sublime developer replied with some corrections and new info. I’ve updated the library listing above with the new info.
