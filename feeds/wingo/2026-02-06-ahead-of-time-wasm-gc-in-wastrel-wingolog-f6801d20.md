---
title: ahead-of-time wasm gc in wastrel — wingolog
url: https://wingolog.org/archives/2026/02/06/ahead-of-time-wasm-gc-in-wastrel
published: "2026-02-06T00:00:00Z"
feed: wingo
guid: https://wingolog.org/archives/2026/02/06/ahead-of-time-wasm-gc-in-wastrel
---
...
Hello friends! Today, a quick note: the [Wastrel](https://codeberg.org/andywingo/wastrel/) ahead-of-time WebAssembly compiler now supports managed memory via garbage collection!
...
Then run a quick check with [hello, world](https://codeberg.org/andywingo/wastrel/src/branch/main/examples/simple-string.wat):
...
Now give a check to [`gcbench`](https://codeberg.org/andywingo/wastrel/src/branch/main/examples/gcbench.wat), a classic GC micro-benchmark:
...
Let’s try with [`quads`](https://codeberg.org/andywingo/wastrel/src/branch/main/examples/quads.wat), which at least has a larger active heap size. This time we’ll compile a binary and then run it:
...
Wastrel with GC is demo-quality, thus far. If you’re interested in the back-story and the making-of, see [my intro to Wastrel](https://wingolog.org/archives/2025/10/30/wastrel-a-profligate-implementation-of-webassembly) article from October, or the FOSDEM talk from last week:

Slides [here](https://wingolog.org/pub/fosdem-wastrel-2026-slides.pdf), if that’s your thing.
...
1. Linus says:[7 February 2026 11:27 AM](#c67d824d200e19c05974406735bdac629b9f04cf)

   And here I spent my autumn parental leave learning c#+wasm so that I would not have to touch JavaScript . Those things are never in vain, but now I feel a little dumb.

   Impressive stuff as always, Andy.

2. Ewan says:[9 February 2026 10:40 AM](#20c1262e9a9c61e115a5e3d65552abb145edc67c)

   I know the project is at the fin stage but is V8 the best comparison for a stand-alone AoT wasm runtime? WAMR from the bytecodealliance is also AoT and pretty efficient!
