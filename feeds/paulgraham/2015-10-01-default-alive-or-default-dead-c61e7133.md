...
feed: paulgraham
guid: http://www.paulgraham.com/aord.html
---
...
![Default Alive or Default Dead?](https://s.turbifycdn.com/aah/paulgraham/default-alive-or-default-dead-5.gif)
...
Asking whether you're default alive or default dead may save you from this. Maybe the alarm bells it sets off will counteract the forces that push you to overhire. Instead you'll be compelled to seek growth in other ways. For example, by [doing
things that don't scale](ds.html), or by redesigning the product in the way only founders can. And for many if not most startups, these paths to growth will be the ones that actually work.
