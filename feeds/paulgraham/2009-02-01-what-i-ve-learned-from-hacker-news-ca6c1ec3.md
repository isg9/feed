...
feed: paulgraham
guid: http://www.paulgraham.com/hackernews.html
---
...
![What I've Learned from Hacker News](https://s.turbifycdn.com/aah/paulgraham/what-i-ve-learned-from-hacker-news-3.gif)
...
filter](http://stupidfilter.org), which is just like a probabilistic spam filter, but trained on corpora of stupid and non-stupid comments instead.
