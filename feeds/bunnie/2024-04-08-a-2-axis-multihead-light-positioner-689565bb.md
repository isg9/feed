---
title: A 2-Axis, Multihead Light Positioner
url: https://www.bunniestudios.com/blog/2024/a-2-axis-multihead-light-positioner/
published: "2024-04-08T06:45:41Z"
feed: bunnie
guid: https://www.bunniestudios.com/blog/?p=7084
---

# A 2-Axis, Multihead Light Positioner

This post is part of a longer-running series about giving users a tangible reason to trust their hardware through my IRIS (Infra-Red, in-situ) technique for the [non-destructive inspection of chips](https://www.bunniestudios.com/blog/2024/iris-infra-red-in-situ-project-updates/). Previously, I discussed the [focus stage](https://www.bunniestudios.com/blog/2024/a-kinematically-coupled-nanometer-resolution-piezo-focus-stage/), [light source](https://www.bunniestudios.com/blog/2024/designing-the-light-source-for-iris/), and [methodology](https://www.bunniestudios.com/blog/2024/sidebar-on-meta-knowledge/) used to develop IRIS.

[![](https://bunniefoo.com/iris/2024/imager-head_sm.jpg)](https://bunniefoo.com/iris/2024/imager-head.jpg)

In my post about [designing the light source](https://www.bunniestudios.com/blog/2024/designing-the-light-source-for-iris/) for IRIS, I covered the electronic design, and noted that an important conclusion of the electronic design exploration was the need for a continuously variable, 2-axis mechanical positioning solution for the light sources. This post dives into the details of the mechanical positioning solution, shown above.
...
![](https://bunniefoo.com/iris/2024/gen1-loop.gif)

Initially, I tried to do the angular positioning [entirely using an electronically addressable strip of LEDs](https://www.bunniestudios.com/blog/2024/designing-the-light-source-for-iris/), but the pixel density was insufficient. So, I decided to bite the bullet and design a continuously adjustable mechanical solution for positioning the lights.

![](https://bunniefoo.com/iris/2024/coordinate_system.png)
...
[![](https://bunniefoo.com/iris/2024/annotated_xsection_sm.jpg)](https://bunniefoo.com/iris/2024/annotated_xsection.png)
...
[![](https://bunniefoo.com/iris/2024/zenith_control_sm.jpg)](https://bunniefoo.com/iris/2024/zenith_control.png)
...
[![](https://bunniefoo.com/iris/2024/zenith-concept_sm.jpg)](https://bunniefoo.com/iris/2024/zenith-concept.png)
...
[![](https://bunniefoo.com/iris/2024/azimuth_control_sm.jpg)](https://bunniefoo.com/iris/2024/azimuth_control.png)
...
With the weight of the load thus fixed, I determined I could probably get away with building the bearing using three “ [cam follower](https://en.wikipedia.org/wiki/Cam_follower)” wheels – basically a ball bearing on a shaft – normally used for [cam](https://en.wikipedia.org/wiki/Cam_(mechanism)) mechanisms. In this case, the “cam” is simply a flat, circular track made out of [POM](https://en.wikipedia.org/wiki/Polyoxymethylene) (for low friction and wear properties), and the “followers” are miniature cam followers [available from Misumi](https://sg.misumi-ec.com/vona2/detail/110310432179/). They are arranged around the central bearing using a hexagonal clamp composed of three identical parts that are screwed together to fully constrain the follower’s motion to stay on the circular path.

[![](https://bunniefoo.com/iris/2024/annotated_xsection2_sm.jpg)](https://bunniefoo.com/iris/2024/annotated_xsection2.png)
...
[![](https://bunniefoo.com/iris/2024/cross-section4_sm.jpg)](https://bunniefoo.com/iris/2024/cross-section4.png)
...
[![](https://bunniefoo.com/iris/2024/annotated_rotation_drive_sm.jpg)](https://bunniefoo.com/iris/2024/annotated_rotation_drive.png)
...
It’s so nice to have the design source for your motion platform. [Jubilee is an open source science platform](https://machineagency.github.io/science_jubilee/) out of [Prof. Nadya Peek’s](https://www.hcde.washington.edu/peek) [Machine Agency Group](https://depts.washington.edu/machines/) (of which I am an [affiliate](https://www.hcde.washington.edu/adjunct-affiliate#affiliate)), and [all of the design files are available](https://github.com/machineagency/jubilee) for editing. It’s nice that there are no barriers to copying their ideas and extending them – I can take the parts of the platform that I like and re-use them with ease.
...
[![](https://bunniefoo.com/iris/2024/full-system_sm.jpg)](https://bunniefoo.com/iris/2024/full-system.png)
...
One other thing I’d like to note about the [Jubilee motion platform](https://machineagency.github.io/science_jubilee/) is that the [assembly instructions](https://jubilee3d.com/index.php?title=Assembly_Instructions) are really thorough and clear. I have a lot of appreciation for the time and effort that went into preparing such comprehensive documentation.

I was able to build the platform on my first attempt in about two days, with little confusion or trouble. I’ve also mentioned this previously, but the Jubilee is available in [kit form via Filastruder](https://www.filastruder.com/collections/jubilee), as well as various spare parts and sub-assemblies. This was a big time saver, because when I copied the elastic lock toolchanger assembly to work as my rotational axis actuator, most of the tricky parts I could just order as spares from the Filastruder site.

The design file for all the parts shown in this post can be found in this [repository](https://github.com/bunnie/iris-hw). As with the fine focus stage, I had all the parts machined by Victor at Jiada; if you want copies of various pieces, and you have Wechat, you can contact him at “Victor-Jiada” and send along the corresponding CAD file. Just let him know that you got his contact via my blog.
...
The main downsides of using a laser for imaging are the cost (good quality lasers run a minimum of $100) and export controls (IR lasers are flagged by the US as requiring elevated scrutiny for export, and are thus harder to buy; incorporating it into the design transitively limits the market for IRIS). Lasers also interact strongly with sub-wavelength features on the chip, which is a plus and a minus; on the upside, there is more opportunity to gather information about the structure of the chip; on the downside, you have to be extremely precise in your laser’s positioning to make reproducible measurements. Also, credit where credit is due: I didn’t come up with the idea of using a laser for this, [Cactus Duper](https://twitter.com/cactusduper) has been independently exploring IRIS techniques, and showed me that lasers can cut through the fog of a heavily doped wafer substrate.
...
Again, a big thanks to [NLnet](https://nlnet.nl/entrust/) and to my [Github Sponsors](https://github.com/sponsors/bunnie/) for making this research possible!
