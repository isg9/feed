...
According to the text of EO13873, being named a foreign adversary means one has engaged in a long-term pattern or serious instances of conduct significantly adverse to the national security of the US. In the case of Huawei, there has been remarkably little hard evidence of this. The published claims of backdoors or violations found in Huawei equipment are pretty run-of-the-mill; they could be just [diagnostic](https://www.techrepublic.com/article/evidence-of-backdoors-in-huawei-equipment-collapse-under-light-scrutiny/) or [administrative tools](https://www.theguardian.com/technology/2019/apr/30/alleged-huawei-router-backdoor-is-standard-networking-tool-says-firm) that were mistakenly left into a production build. If this is the standard of evidence required to designate a foreign adversary, then most equipment vendors are guilty and at risk of being designated an adversary. For example, glaring flaws in Samsung SmartTVs enabled the [CIA’s WeepingAngel malware](https://wikileaks.org/ciav7p1/cms/page_12353643.html) to listen in on your conversations, yet Samsung is probably safe from this list.

If Huawei has truly engaged in a long-term pattern of conduct significantly adverse to national security, surely, some independent security research would have already found and published a paper on this. Given the level of fame and notoriety such a researcher would gain for finding the “smoking gun”, I can’t imagine the relative lack of high-profile disclosures is for a lack of effort or motivation. Hundreds of CVEs (Common Vulnerabilities and Exposures) have been [filed against Huawei](https://cve.mitre.org/cgi-bin/cvekey.cgi?keyword=huawei), yet none have been cited as national security threats. Meanwhile, even the NSA agrees that the Intel Management Engine is a threat, and has requested a [special setting in Intel CPUs to disable it for their own secure computing platforms](https://www.csoonline.com/article/3220476/researchers-say-now-you-too-can-disable-intel-me-backdoor-thanks-to-the-nsa.html).

If Huawei were to be added to this list, it would set a significantly lower bar for evidence compared to the actions against similarly classified adversaries such as [Iran](https://www.nytimes.com/video/world/middleeast/100000006558124/explosive-mine-removed-from-ship-in-gulf-of-oman.html) or [North Korea](https://www.bloomberg.com/news/articles/2019-01-14/north-korea-s-nuclear-program-quietly-advances-pressuring-trump). Lowering the bar means other countries can justify taking equivalent action against the US or its allies with similarly scant evidence. This greatly amplifies the risk of this trade war spiraling even further out of control.
...
![](https://bunniefoo.com/bunnie/huawilt_comparison.png)

*Above: Huawei 2018 revenue in comparison to other companies or country’s GDP.*

Now, let’s compare this to the potential economic damage of a bomb being dropped on a factory: let’s say an oil refinery. [One report](http://www.oliverwyman.com/content/dam/marsh/Documents/PDF/UK-en/100%20Largest%20Losses%2023rd%20Edition-03-2014.pdf) indicated that the largest oil refinery explosion since 1974 caused around $1.8 billion in economic damage. So carving Huawei out of the global supply chain with an army of bureaucrats is better bang for the buck than sending in an actual army with guns, if the goal is to inflict economic damage.

[![](https://bunniefoo.com/bunnie/huawilt_losses.png)](http://www.oliverwyman.com/content/dam/marsh/Documents/PDF/UK-en/100%20Largest%20Losses%2023rd%20Edition-03-2014.pdf)
...
[![](https://bunniefoo.com/bunnie/huawilt_unguided.png)](https://www.space.com/41056-japan-private-rocket-launch-explosion.html)
