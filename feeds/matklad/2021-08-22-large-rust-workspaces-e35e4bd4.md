...
feed: matklad
guid: https://matklad.github.io/2021/08/22/large-rust-workspaces.html
---
...
To cut to the chase, I think for projects in between ten thousand and one million lines of code, the flat layout makes the most sense. rust-analyzer (200k lines) is good example here. The [repository](https://github.com/rust-analyzer/rust-analyzer) is laid out this:
...
For large projects a lot of repository bloat often comes from ad-hoc automation — Makefiles and various prepare.sh scripts here and there. To avoid both the bloat and proliferation of ad-hoc workflows, write all automation in Rust in a dedicated crate. One pattern useful for this is [`cargo xtask`](https://github.com/matklad/cargo-xtask).
