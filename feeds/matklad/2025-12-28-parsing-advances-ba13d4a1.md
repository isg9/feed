...
published: "2025-12-28T00:00:00Z"
feed: matklad
guid: https://matklad.github.io/2025/12/28/parsing-advances.html
---
...
*Fuel:* parser has a `fuel: Cell` field, which is decremented even by “readonly” lookahead methods, and topped up every time the parser consumes a token. Fuel is useful to make you parser crash somewhat cleanly, though the crash is typically still removed from problematic function by several stack frames.
