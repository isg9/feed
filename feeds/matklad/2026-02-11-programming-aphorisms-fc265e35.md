...
feed: matklad
guid: https://matklad.github.io/2026/02/11/programming-aphorisms.html
---
...
*Second*, I avoided “midlayer mistake” by making sure that every aspect of options is user-configurable. Easy to do in Zig, where all fields are public. I learned about [midlayer mistake](https://lwn.net/Articles/336262/) from a GitHub comment by [Josh Triplett](https://joshtriplett.org).

*Third*, I provided a “shortcut”, the `from_environment` convenience function that cuts across abstraction layers. I learned the “shortcut” aphorism from [*Django Views — The Right Way*.](https://spookylukey.github.io/django-views-the-right-way/detail-view.html#discussion-layering-violations-shortcuts-vs-mixins) Germane to the present article, I read that post a decade after I had touched Django the last time. It was useless to me on the object level. On the meta level, reading the article solidified and *named* several programming tricks for me. See reverberations in [*How to Make a 💡?*.](https://rust-analyzer.github.io/blog/2020/09/28/how-to-make-a-light-bulb.html)
