...
feed: matklad
guid: https://matklad.github.io/2021/05/31/how-to-test.html
---
...
## [Test Driven Design Ossification](\#Test-Driven-Design-Ossification)
...
## [Test Features, Not Code](\#Test-Features-Not-Code)
...
## [Make Tests Fast](\#Make-Tests-Fast)
...
**Key point:** architecture the software to keep as much as possible [sans io](https://sans-io.readthedocs.io). Let the caller do input and output, and let the callee do compute. It doesn’t matter if the callee is large and complex. Even if it is the whole compiler, testing is fast and easy as long as no IO is involved.
...
## [Externalized Tests](\#Externalized-Tests)
...
## [Beyond Example Based Testing](\#Beyond-Example-Based-Testing)
...
## [The Concurrent World](\#The-Concurrent-World)
...
**Key Point:** grab a (large) cup of coffee and go read [Go statement considered harmful](https://vorpus.org/blog/notes-on-structured-concurrency-or-go-statement-considered-harmful/). I will wait until you are done, and then proceed with my article.
...
**Key point:** use [https://bors.tech](https://bors.tech), a no-nonsense implementation of “not rocket science” rule.
