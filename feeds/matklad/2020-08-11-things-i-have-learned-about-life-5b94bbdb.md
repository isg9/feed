---
title: Things I Have Learned About Life
url: https://matklad.github.io/2020/08/11/things-I-have-learned-about-life.html
published: "2020-08-11T00:00:00Z"
feed: matklad
guid: https://matklad.github.io/2020/08/11/things-I-have-learned-about-life.html
---
...
## [Romance & Polyamory](\#Romance-Polyamory)
...
2. A relation with an extremely monogamous (as in, expressing a lot of distress due to jealousy) S.

3. A relation with another poly person A, at which point it finally clicked that if I like 1 & 3, and don’t like 2, than maybe it makes sense for me to read that book as well.
...
M: I am autistic. + A: Wait wat? On the contrary, you are the first person I’ve met who doesn’t seem insane. Wait a second…
...
After I had formed a hypothesis that I might have some autistic traits, I thought that Meursault feels very similar to me, and after some googling, presto: [https://www.dovepress.com/camuss-letranger-and-the-first-description-of-a-man-with-aspergers-syn-peer-reviewed-fulltext-article-PRBM](https://www.dovepress.com/camuss-letranger-and-the-first-description-of-a-man-with-aspergers-syn-peer-reviewed-fulltext-article-PRBM)

Apparently, Meursault had a real life prototype, Camus’s best friend, and looks like that friend had Asperger’s since before it was was named! Hey, the hypothesis that I am autistic has predictive power!
...
## [Mechanism rule the world](\#Mechanism-rule-the-world)
...
2. State that I don’t find it appropriate.

3. Point out specific ways to improve the comment.
...
## [Mechanisms rule me](\#Mechanisms-rule-me)
...
I am less successful with the torrent of low-quality superficial info from the internet. Luckily, I’ve never had any social network profiles (I guess for the same reason as with alcohol), but I started reading reddit at some point, and that eats into my attention. `/etc/hosts` and RSS help a lot here.
...
I guess that’s it for now and the nearest future! If you have comments, suggestions or just want to say hello, feel free to drop me a email (in GitHub profile) or contact me on Telegram (@matklad).
