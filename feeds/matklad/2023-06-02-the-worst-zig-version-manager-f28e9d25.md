...
url: https://matklad.github.io/2023/06/02/the-worst-zig-version-manager.html
published: "2023-06-02T00:00:00Z"
feed: matklad
guid: https://matklad.github.io/2023/06/02/the-worst-zig-version-manager.html
---

# The Worst Zig Version Manager

Jun 2, 2023./getzig.ps1
...
[https://github.com/matklad/hello-getzig](https://github.com/matklad/hello-getzig)
...
I like how we do this in [TigerBeetle](https://github.com/tigerbeetledb/tigerbeetle/blob/56d14e82769deb6817809f866253220ae0f499d1/scripts/install_zig.sh). We don’t use `zig` from `PATH`. Instead, we just put the correct version of Zig into `./zig` folder in the root of the repository, and run it like this:
...
But is there perhaps some scripting language which is shared between Windows and Unix? [@cspotcode](https://github.com/cspotcode) suggests [a horrible workaround](https://cspotcode.com/posts/polyglot-powershell-and-bash-script). You can write a script which is *both* a bash script and a powershell script. And it even isn’t too too ugly!
...
A proof-of-concept `getzig.ps1` is at the start of this article. Note that I don’t know bash, powershell, and how to download files from the Internet securely, so the above PoC was mostly written by Chat GPT. But it seems to work on my machine. I clone [https://github.com/matklad/hello-getzig](https://github.com/matklad/hello-getzig) and run
