...
feed: matklad
guid: https://matklad.github.io/2025/12/30/memory-safety-is.html
---
...
Note that the present post is 90% sophistry in the style of Zeno — I don’t think you need a water-tight definition to have a reasonable discussion, and no definition can save an unreasonable one. But thinking *about* definitions focuses the mind.

The crux of my argument:

> Memory safety is a property of an *implementation*.

That’s the problem with many definitions — they are about a wrong kind of thing, and are confused for that reason. For example, a definition used in [*Memory*
*Safety for Skeptics*](https://queue.acm.org/detail.cfm?id=3773095):
...
Another popular definition comes from [*Type Systems*](https://courses.grainger.illinois.edu/cs421/fa2018/CS421A/resources/cardelli.pdf) paper by Luca Cardelli.
...
In addition to LM (abstract machine), we also have a concrete machine CM on hand, such as x86\_64 running Linux userspace, or Wasm in the browser. Concrete machine comes with its own language C and its own semantics.
...
As a positive example, consider [Fil-C](https://fil-c.org) (see also [*A*
*note on Fil-C*](https://graydon2.dreamwidth.org/320265.html)). This is an *implementation* of C that maintains C semantics, is safe, and is arguably sufficiently efficient to be practical. Unlike my Lil-C, Fil-C is a useful thing (and requires *much* more effort to pull off).
