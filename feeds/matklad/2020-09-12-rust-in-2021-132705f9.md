...
feed: matklad
guid: https://matklad.github.io/2020/09/12/rust-in-2021.html
---
...
This is my response for this year’s [call for blog posts](https://blog.rust-lang.org/2020/09/03/Planning-2021-Roadmap.html). I am writing this as a language implementor, not as a language user. I also don’t try to prioritize the problems. The two things I’ll mention are the things that worry me most without reflecting on the overall state of the project. They are not necessary the most important things.

## [Funding Teams to Work on Rust](\#Funding-Teams-to-Work-on-Rust)
...
That is, I want to simplify working on the compiler itself to it being just a crate. This section of the article expands on the comment I’ve made on the [irlo](https://internals.rust-lang.org/t/experience-report-contributing-to-rust-lang-rust/12012/17?u=matklad) a while ago.
...
Before I go into details about my vision here, I want to give shout-outs to [@Mark-Simulacrum](https://github.com/Mark-Simulacrum/), [@mark-i-m](https://github.com/mark-i-m), and [@jyn514](https://github.com/jyn514) who already did a lot of work on simplifying the build process in the recent several months.
...
### [How Simple Could the Build Process Be?](\#How-Simple-Could-the-Build-Process-Be)
...
### [Why Today’s Build Process is not Simple?](\#Why-Today's-Build-Process-is-not-Simple)
