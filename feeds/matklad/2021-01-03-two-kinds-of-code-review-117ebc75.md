...
url: https://matklad.github.io/2021/01/03/two-kinds-of-code-review.html
published: "2021-01-03T00:00:00Z"
feed: matklad
guid: https://matklad.github.io/2021/01/03/two-kinds-of-code-review.html
---
...
I personally always felt that the review process I use falls quite short of the proper level of quality. Which didn’t really square with me bootstrapping a couple of successful open source projects. Now I think that I just happen to optimize for the people’s aspect of the review process, while most guides (with a notable exception of [Optimistic Merging](http://hintjens.com/blog:106)) focus on code aspects.

Now, (let me stress this point), I do not claim that the second goal is inherently better (though it sounds nicer). It’s just that in the context of both [IntelliJ Rust](https://intellij-rust.github.io) and [rust-analyzer](https://rust-analyzer.github.io) (green-field projects with massive scope, big uncertainties and limited paid-for hours) growing the community of contributors and maintainers was more important than maintaining perfectly clean code.
