...
feed: matklad
guid: https://matklad.github.io/2018/01/03/make-your-own-make.html
---
...
One of my favorite features of [Cargo](https://doc.rust-lang.org/cargo/) is that it is **not** a general purpose build tool. This allows Cargo to really excel at the task of building Rust code, without usual Turing tarpit of build configuration files. I have yet to see a complicated Cargo.toml file!
...
[xtask](https://github.com/matklad/cargo-xtask/) specification is a modern version of this idea.
...
Two tools which significantly improve on the ease of use and ergonomics are [just](https://github.com/casey/just) and [cargo make](https://github.com/sagiegurari/cargo-make). Alas, they still mostly rely on the shell to actually execute the tasks.
...
Suppose that we want to add a couple of tasks, like generating some code from some specification in the [RON](https://github.com/ron-rs/ron) format, or grepping the source code for `TODO` marks.
...
Then, we add a [`[workspace]`](https://doc.rust-lang.org/cargo/reference/manifest.html#the-workspace-section) to the parent package:
