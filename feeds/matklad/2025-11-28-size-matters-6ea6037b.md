---
title: Size Matters
url: https://matklad.github.io/2025/11/28/size-matters.html
published: "2025-11-28T00:00:00Z"
feed: matklad
guid: https://matklad.github.io/2025/11/28/size-matters.html
---
...
[TigerStyle](https://github.com/tigerbeetle/tigerbeetle/blob/809fe06a2ffcc09a92110f6aa46546ba9a8ad2bf/docs/TIGER_STYLE.md) is pretty strict about some arbitrary limits:

> …we enforce a **hard limit of 70 lines per** **function** …
>
> … hard limit all line lengths, without exception, to at most 100 columns …

At the same time, we have a few quite large files, to the point of having to explicitly exclude them from our “no large binary blobs in the git history” policy: [tidy.zig#L746](https://github.com/tigerbeetle/tigerbeetle/blob/809fe06a2ffcc09a92110f6aa46546ba9a8ad2bf/src/tidy.zig#L746).

Just how large should you make your functions/classes/files? I have two answers here.

## [Minimize The Cut](\#Minimize-The-Cut)
...
You should move a data structure to a separate file when it is self contained. It doesn’t matter if it is ten or ten thousand lines long. We have [replica.zig](https://github.com/tigerbeetle/tigerbeetle/blob/809fe06a2ffcc09a92110f6aa46546ba9a8ad2bf/src/vsr/replica.zig), but also [timestamp\_range.zig](https://github.com/tigerbeetle/tigerbeetle/blob/809fe06a2ffcc09a92110f6aa46546ba9a8ad2bf/src/lsm/timestamp_range.zig).
...
## [Honor Physical Limits](\#Honor-Physical-Limits)
