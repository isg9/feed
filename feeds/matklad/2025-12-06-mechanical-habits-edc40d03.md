...
feed: matklad
guid: https://matklad.github.io/2025/12/06/mechanical-habits.html
---
...
## [Epistemic Aside](\#Epistemic-Aside)
...
- Pieter Hintjens writings, specifically, the idea of [Optimistic Merging](https://hintjens.gitbooks.io/social-architecture/content/chapter4.html#:~:text=Maintainers%20SHALL%20merge%20correct%20patches%20rapidly.)
...
## [Not Rocket Science Rule](\#Not-Rocket-Science-Rule)

I feel like I link [https://graydon2.dreamwidth.org/1597.html](https://graydon2.dreamwidth.org/1597.html) from every second post of mine, so I’ll keep it short this time.
...
## [Tidy Script](\#Tidy-Script)

This is another idea borrowed from Rust. Use a `tidy` file to collect various project-specific linting checks as tests. The biggest value of such [`tidy.zig`](https://github.com/tigerbeetle/tigerbeetle/blob/0.16.66/src/tidy.zig) is its mere existence. It’s much easier to add a new check than to create “checking infrastructure”. Some checks we do at TigerBeetle:
...
I don’t remember the origin here, but [https://deno.com/benchmarks](https://deno.com/benchmarks) certainly is an influence.
...
- [https://github.com/tigerbeetle/tigerbeetle/tree/0.16.66/src/devhub](https://github.com/tigerbeetle/tigerbeetle/tree/0.16.66/src/devhub)
- [http://tigerbeetle.github.io/tigerbeetle/](http://tigerbeetle.github.io/tigerbeetle/)
...
I gave a talk about using DevHub for visualizing fuzzing results for HYTRADBOI ( [video](https://www.hytradboi.com/2025/c222d11a-6f4d-4211-a243-f5b7fafc8d79-rocket-science-of-simulation-testing)).

Another tip: JSON file in a git repository is a fine database to power such an internal website. [JSONMutexDB](https://tailscale.com/blog/an-unlikely-database-migration) for the win.
...
A useful trick for solving bitrot is to chain a new habit onto an existing one. Avoid multiplying entry points ( [*O(1) Build File*](https://matklad.github.io/2023/12/31/O(1)-build-file.html)). The appropriate entry point here are the tests. So each micro benchmark is going to be just a test:
...
[https://github.com/tigerbeetle/tigerbeetle/pull/3405](https://github.com/tigerbeetle/tigerbeetle/pull/3405)
