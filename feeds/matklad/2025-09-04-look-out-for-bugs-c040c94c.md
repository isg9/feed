...
feed: matklad
guid: https://matklad.github.io/2025/09/04/look-for-bugs.html
---
...
One of my biggest mid-career shifts in how I write code was internalizing the idea from this post: [*Don’t Write Bugs*](https://www.teamten.com/lawrence/programming/dont-write-bugs.html)
...
Identify the key data structures and fields, and search for all places where they are created and modified.

You want to see a slice across space and time, state and control flow (c.f. [*Concurrent Expression Problem*](https://matklad.github.io/2021/04/26/concurrent-expression-problem.html)).
