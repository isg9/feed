---
title: Elements Of a Great Markup Language
url: https://matklad.github.io/2022/10/28/elements-of-a-great-markup-language.html
published: "2022-10-28T00:00:00Z"
feed: matklad
guid: https://matklad.github.io/2022/10/28/elements-of-a-great-markup-language.html
---
...
EDIT: if you like this post, you should definitely check out [https://djot.net](https://djot.net).
...
For example `http://example.com[]` gets parsed as `//example.com`, and the converter knows basic url schemes. And of course there’s a generic link syntax for corner cases where a URL syntax isn’t a valid AsciiDoctor syntax:
...
Great markup format contains a tasteful selection of syntactic forms to express common patterns: lists, admonitions, links, footnotes, cross-references, quotes, tables, images.

The syntax is fundamentally sugary, and expands to the standard tree-of-nodes-with-attributes.

## [Composable Processing](\#Composable-Processing)
