---
title: Why is Rust the Most Loved Programming Language?
url: https://matklad.github.io/2020/02/14/why-rust-is-loved.html
published: "2020-02-14T00:00:00Z"
feed: matklad
guid: https://matklad.github.io/2020/02/14/why-rust-is-loved.html
---
...
Rust is my favorite programming language (other languages I enjoy are Kotlin and Python). In this post I want to explain why I, somewhat irrationally, find this language so compelling. The post does not try to explain why Rust is the most loved language according to [StackOverflow survey](https://insights.stackoverflow.com/survey/2019#most-loved-dreaded-and-wanted) :-)
...
## [It’s All the Small Things!](\#It's-All-the-Small-Things)
...
## [Keyword First Syntax](\#Keyword-First-Syntax)
...
## [Type Last Syntax](\#Type-Last-Syntax)
...
## [No Dangling Else](\#No-Dangling-Else)
...
## [Everything Is An Expression, Including Blocks](\#Everything-Is-An-Expression-Including-Blocks)
...
## [Immutable/non-Reassignable by Default](\#Immutable-non-Reassignable-by-Default)
...
## [Namespaced Enums](\#Namespaced-Enums)
...
Swift does even a nicer trick here, by using an `.VariantName` syntax to refer to a namespaced enum ( [docs](https://docs.swift.org/swift-book/LanguageGuide/Enumerations.html#ID147)). This makes matching less verbose and completely dodges the sad Rust ambiguity between constants and bindings:
...
## [Syntactic Separation of Fields and Methods](\#Syntactic-Separation-of-Fields-and-Methods)
...
## [Crate Visibility](\#Crate-Visibility)
...
## [Trivial Data Types](\#Trivial-Data-Types)
