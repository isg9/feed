...
url: /2023/11/27/simd-base64
published: "2023-11-27T00:00:00Z"
feed: mcyoung
guid: /2023/11/27/simd-base64
---
...
![perf perf perf](/assets/images/simd-b64/graph.png)
...
This post is mostly about [`vb64`](https://docs.rs/vb64/latest/vb64/) (which stands for *v* ector *b* ase *64*), a base64 codec I wrote to see for myself if Rust’s `std::simd` library is any good, but it’s also an excuse to talk about SIMD in general.

What *is* SIMD, anyways? Let’s dive in.

If you want to skip straight to the writeup on `vb64`, click [here](#parsing-with-simd).

## [Problems with Physics](\#problems-with-physics)
...
### [Procedural Code Is Slow](\#procedural-code-is-slow)
...
![some 256-bit vectors](/assets/images/simd-b64/vectors.png)
...
[godbolt](https://godbolt.) [Rust](#code:2)
...
![first two popcnt merge steps](/assets/images/simd-b64/popcnt.png)
...
[godbolt](https://godbolt.) [Rust](#code:3)
...
### [Scaling Up: Operations on Real Vectors](\#scaling-up-operations-on-real-vectors)
...
1. Bitwise operations. These don’t need to specify a lane width because it’s always implicitly `1`: they’re *bit* wise.

2. Lane-wise arithmetic. This is addition, subtraction, multiplication, division (both int and float), and shifts[1](#fn:1) (int only). Lane-wise min and max are also common. These require specifying a lane width. Typically the smallest number of lanes is two or four.

3. Lane-wise compare. Given `a` and `b`, we can create a new *mask vector* `m` such that `m[i] = a[i] < b[i]` (or any other comparison operation). A mask vector’s lanes contain boolean values with an unusual bit-pattern: all-zeros (for false) or all-ones (for true)[2](#fn:2).
...
![diagram of a broadcast](/assets/images/simd-b64/broadcast.png)
...
![diagram of a interleave](/assets/images/simd-b64/interleave.png)
...
![diagram of a rotate](/assets/images/simd-b64/rotate.png)
...
### [Intrinsics and Instruction Selection](\#intrinsics-and-instruction-selection)
...
Compiling with something like `-march=native` or `-Ctarget-cpu=native` gets you “the best” code possible for the machine you’re building on, but it might not be portable[3](#fn:3) to different processors. Gentoo was quite famous for building packages from source on user machines to take advantage of this (not to mention that they loved using `-O3`, which mostly exists to slow down build times with little benefit).
...
## [Parsing with SIMD](\#parsing-with-simd)
...
[godbolt](https://godbolt.) [Rust](#code:6)

That’s one branch eliminated[4](#fn:4). ✅

The others will not prove so easy. Let’s turn our attention to the innermost loop next, branches (2), (3), and (4).

### [The Hottest Loop](\#the-hottest-loop)
...
3. `A` is zero in base64. If we’re parsing a truncated chunk, padding it with `A` won’t change the value[5](#fn:5).
...
### [ASCII to Sextet](\#ascii-to-sextet)
...
### [SIMD Hash Table](\#simd-hash-table)
...
This is not my original idea; I came across a [GitHub issue](https://github.com/WojciechMula/base64simd/issues/3) where an anonymous user points out this perfect hash.
...
There is a small wrinkle here: [`Simd::swizzle_dyn()`](https://doc.rust-lang.org/std/simd/struct.Simd.html#method.swizzle_dyn) requires that the index array be the same length as the lookup table. This is annoying because right now `ascii` is a `Simd<u8, 4>`, but that will not be the case later on, so I will simply sweep this under the rug.

Note that we no longer get validation as a side-effect of computing the sextets vector. The same GitHub issue also provides an exact bloom-filter for checking that a particular byte is valid; you can see my implementation [here](https://github.com/mcy/vb64/blob/894f833e933860e070dabcfcc189430c45fecbd7/src/simd.rs#L93). I’m not sure how the OP constructed the bloom filter, but the search space is small enough that you could have written a little script to brute force it.

### [Riffling the Sextets](\#riffling-the-sextets)
...
[godbolt](https://godbolt.) [Rust](#code:12)
...
![the riffling operation](/assets/images/simd-b64/riffle.png)
...
> `swizzle!()` is a helper macro[6](#fn:6) for generating generic implementations of `std::simd::Swizzle`, and `array!()` is something I wrote for generating generic-length array constants; the closure is called once for each `i in 0..N`.
...
### [Preallocating with Slop](\#preallocating-with-slop)
...
### [Delaying Failure](\#delaying-failure)
...
### [Unroll It Harder](\#unroll-it-harder)
...
![a performance graph; our code is really good compared to the baseline, but variance is high](/assets/images/simd-b64/graph-old.png)
...
### [Unroll and Jam, Revisited](\#unroll-and-jam-revisited)
...
![a performance graph; our code is even better and the variance is very tight](/assets/images/simd-b64/graph.png)
...
### [Encoding? Web-Safe?](\#encoding-web-safe)

Writing an encoding function is simple enough: first, implement an `encode_hot()` function that reverses the operations from `decode_hot()`. The perfect hash from before won’t work, so you’ll need to [invent a new one](https://github.com/mcy/vb64/blob/main/src/simd.rs#L170).
...
1. Shifts are better understood as arithmetic. They have a lane width, and closely approximate multiplication and division. AVX2 doesn’t even have vector shift *or* vector division: you emulate it with multiplication. [↩︎](#fnref:1)
...
This function returns `x` if `a == b`, and `y` otherwise. Can you tell why? [↩︎](#fnref:2)

3. Target features also affect ABI in subtle ways that I could write many, many more words on. Compiling libraries you plan to distribute with weird target feature flags is a recipe for disaster. [↩︎](#fnref:3)
...
As for getting LLVM to find the “branchless” version of the lookup table? The search space is quite large, and this kind of “general strength reduction” problem is fairly open (keywords: “superoptimizers”). [↩︎](#fnref:4)

5. To be clear on why this works: suppose that in our reference implementation, we only handle inputs that are a multiple-of-4 length, and are padded with `=` as necessary, and we treat `=` as zero in the `match`. Then, for the purposes of computing the `bytes` value (before appending it to `out`), we can assume the chunk length is always 4. [↩︎](#fnref:5)

6. See [`vb64/src/util.rs`](https://github.com/mcy/vb64/blob/ed75566393a25d174a2766c3f8947d9c6a506315/src/util.rs). [↩︎](#fnref:6)
