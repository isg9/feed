...
url: https://nullprogram.com/blog/2011/04/09/
published: "2011-04-09T00:00:00Z"
feed: nullprogram
guid: https://nullprogram.com/blog/2011/04/09/
---
...
nullprogram.com/blog/2011/04/09/

Looking at my server logs the other I noticed that the unnamed [Chess
engine I wrote this past October](/blog/2010/10/17/) recently got [some attention on
the Immortal Chess forum](http://immortalchess.net/forum/showthread.php?t=8845). As far as I know this is the first time anyone who’s good at Chess has played it. They were analyzing its behavior a bit too.
...
Have a comment on this article? Start a discussion in my [public inbox](https://lists.sr.ht/~skeeto/public-inbox) by sending an email to [~skeeto/public-inbox@lists.sr.ht](mailto:~skeeto/public-inbox@lists.sr.ht?Subject=Re%3A%20October's%20Chess%20Engine%20Gets%20Some%20Attention) \[ [mailing list etiquette](https://man.sr.ht/lists.sr.ht/etiquette.md)\] , or see [existing discussions](https://lists.sr.ht/~skeeto/public-inbox?search=October%27s+Chess+Engine+Gets+Some+Attention).
