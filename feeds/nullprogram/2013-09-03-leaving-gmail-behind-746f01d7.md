...
url: https://nullprogram.com/blog/2013/09/03/
published: "2013-09-03T00:00:00Z"
feed: nullprogram
guid: https://nullprogram.com/blog/2013/09/03/
---

# Leaving Gmail Behind

## [Leaving Gmail Behind](/blog/2013/09/03/)

September 03, 2013

nullprogram.com/blog/2013/09/03/

*Update May 2017*: Shortly after [switching to modal editing](/blog/2017/04/01/), I stopped using Emacs and Notmuch as my mail client. I [now use Mutt and
Vim](/blog/2017/06/15/).
...
That convenience kept me as a user after college up until now. As of two weeks ago I changed my e-mail address. You can find it listed below my portrait on this page (if you’re reading this on my website). Not only am I using my own domain name, but I’m running my own e-mail server. After attempting, and failing, at creating a decent setup with [mu4e](http://www.djcbsoftware.nl/code/mu/mu4e.html), I ended up following this guide:

- [A Hacker’s Replacement for GMail](http://dbpmail.net/essays/2013-06-29-hackers-replacement-for-gmail.html)

It’s built around the superb [notmuch mail indexer](http://notmuchmail.org/), which includes a powerful, fast Emacs e-mail client. Just from its technical superiority **I’m wishing I switched to notmuch years ago**. I’m now understanding for the first time why all those old fogey hackers like to use e-mail for everything: mailing lists, software patches, bug reporting, etc. E-mail a user interface agnostic system, giving everyone their own choice. The tricky part is setting up a decent interface to it.

### Prompting the change

As you know, [Google Reader shut down this past July](/blog/2013/06/13/). This left me using only two Google services: Talk and Mail. Not only is Talk easily replaceable — it has no significant data on Google’s servers — [it will be shut down soon as well](http://windowspbx.blogspot.com/2013/05/hangouts-wont-hangout-with-other.html). I would need to move to a different XMPP server anyway. If I could move off of Gmail, I would finally be able to discontinue my Google account *for good*!
...
There are also the technical reasons. It’s a bit embarrassing to admit, but the final straw that pushed me to finally leaving Gmail was [the new compose interface](http://gizmodo.com/gmails-new-compose-window-will-soon-be-your-only-choic-1123199551) — a technical issue rather than a privacy issue — which was pushed out just a few days before I left. I found it to be very unpleasant and, worse, completely incompatible with Pentadactyl, as there is no longer a plain-text option (the one listed is a fake). A huge technical step backwards, towards the layman and away from the power user. I could do so much better than this.
...
[Brian](http://www.50ply.com/) was a guinea pig for me, because, between the two of us, he was actually the first one to move to his own e-mail platform. Seeing his success was a big encouragement for me. Not only could it be done fairly easily, but the results would be a huge improvement. This was all within my grasp!
...
I ended up going with [Digital Ocean](https://www.digitalocean.com/?refcode=a613ef5c79c1), as the linked guide suggested. The smallest, cheapest offering is more than suitable for my needs both as an e-mail server and an XMPP server. It will probably be handy for [other short-lived, experimental](/blog/2013/01/26/) servers too.

[I used getmail](http://www.mattcutts.com/blog/backup-gmail-in-linux-with-getmail/) to get all of my old mail onto the mail server in the Maildir format. It was completely straightforward and probably the easiest part of it all.
...
Have a comment on this article? Start a discussion in my [public inbox](https://lists.sr.ht/~skeeto/public-inbox) by sending an email to [~skeeto/public-inbox@lists.sr.ht](mailto:~skeeto/public-inbox@lists.sr.ht?Subject=Re%3A%20Leaving%20Gmail%20Behind) \[ [mailing list etiquette](https://man.sr.ht/lists.sr.ht/etiquette.md)\] , or see [existing discussions](https://lists.sr.ht/~skeeto/public-inbox?search=Leaving+Gmail+Behind).

« [JavaScript Function Metaprogramming](/blog/2013/08/17/)

» [Introducing Elfeed, an Emacs Web Feed Reader](/blog/2013/09/04/)
