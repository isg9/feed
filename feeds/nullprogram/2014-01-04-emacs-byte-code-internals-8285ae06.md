...
url: https://nullprogram.com/blog/2014/01/04/
published: "2014-01-04T00:00:00Z"
feed: nullprogram
guid: https://nullprogram.com/blog/2014/01/04/
---
...
The easiest place to access the opcode listing is in [bytecomp.el](http://cvs.savannah.gnu.org/viewvc/emacs/emacs/lisp/emacs-lisp/bytecomp.el?view=markup). Beware that some of the opcode comments are currently out of date.
...
There are two ways to create a byte-code object: using a byte-code object literal or with `make-byte-code`. [Like vector literals](/blog/2012/07/17/), byte-code literals don’t need to be quoted.
...
Have a comment on this article? Start a discussion in my [public inbox](https://lists.sr.ht/~skeeto/public-inbox) by sending an email to [~skeeto/public-inbox@lists.sr.ht](mailto:~skeeto/public-inbox@lists.sr.ht?Subject=Re%3A%20Emacs%20Byte-code%20Internals) \[ [mailing list etiquette](https://man.sr.ht/lists.sr.ht/etiquette.md)\] , or see [existing discussions](https://lists.sr.ht/~skeeto/public-inbox?search=Emacs+Byte-code+Internals).
