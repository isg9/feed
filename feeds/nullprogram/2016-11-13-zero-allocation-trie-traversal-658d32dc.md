...
url: https://nullprogram.com/blog/2016/11/13/
published: "2016-11-13T00:00:00Z"
feed: nullprogram
guid: https://nullprogram.com/blog/2016/11/13/
---
...
reversal](https://xlinux.nist.gov/dads/HTML/SchorrWaiteGraphMarking.html) for binary graphs (1965) — which I originally learned from reading the [Scheme 9 from Outer Space](http://t3x.org/s9fes/) garbage collector source — and [Morris in-order traversal](http://www.geeksforgeeks.org/morris-traversal-for-preorder/) (1979) for binary trees. The former requires two extra tag bits per node and the latter requires no modifications at all.
...
suggestions](https://news.ycombinator.com/item?id=12943339) such as leaving the traversal pointers intact, particularly in the case of a breadth-first search, which, until the next trie modification, allows for concurrent follow-up traversals.

- [c](/tags/c/)
- [compsci](/tags/compsci/)

Have a comment on this article? Start a discussion in my [public inbox](https://lists.sr.ht/~skeeto/public-inbox) by sending an email to [~skeeto/public-inbox@lists.sr.ht](mailto:~skeeto/public-inbox@lists.sr.ht?Subject=Re%3A%20Zero-allocation%20Trie%20Traversal) \[ [mailing list etiquette](https://man.sr.ht/lists.sr.ht/etiquette.md)\] , or see [existing discussions](https://lists.sr.ht/~skeeto/public-inbox?search=Zero-allocation+Trie+Traversal).
