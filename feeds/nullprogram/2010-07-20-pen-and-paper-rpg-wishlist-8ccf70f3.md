---
title: Pen and Paper RPG Wishlist
url: https://nullprogram.com/blog/2010/07/20/
published: "2010-07-20T00:00:00Z"
feed: nullprogram
guid: https://nullprogram.com/blog/2010/07/20/
---

# Pen and Paper RPG Wishlist

## [Pen and Paper RPG Wishlist](/blog/2010/07/20/)
...
**Licensing**. The closest thing tabletop gaming has to a Free Software license would be the [Open
Game License](http://en.wikipedia.org/wiki/Open_Game_License) (OGL), which is still pretty restrictive. I would love for the source materials to be licensed at least loosely enough that I could print out my own copies for cheap (assuming they are print friendly, per above). Have some new players sitting down at the table? To get them started, give them that stapled-together player handbook you printed out. There's RPG evangelism for you.

The [Fudge role-playing
game system](http://www.fudgerpg.com/fudge.html) has both these attributes down pretty well. The Fudge manual is very print friendly PDF with explicit permission to share it with your friends. However, just as [yacc](http://en.wikipedia.org/wiki/Yacc) is a compiler compiler, Fudge is really a game system *system*, a system for creating game systems, so it's only part of what is needed to play a game.
...
Fortunately there are some decent, generic world generation tools for GMs out there, such as [random inn
generators](http://www.inkwellideas.com/roleplaying_tools/random_inn/), [random
dungeon](http://inkwellideas.com/roleplaying_tools/random_dungeon/) [generators](http://www.velvet-edge.com/RisusMonkeyMap.html), and so on. And [another one](http://www.dizzydragon.net/adventuregenerator/home). [I've mentioned this
before](/blog/2010/05/13/).
...
Have a comment on this article? Start a discussion in my [public inbox](https://lists.sr.ht/~skeeto/public-inbox) by sending an email to [~skeeto/public-inbox@lists.sr.ht](mailto:~skeeto/public-inbox@lists.sr.ht?Subject=Re%3A%20Pen%20and%20Paper%20RPG%20Wishlist) \[ [mailing list etiquette](https://man.sr.ht/lists.sr.ht/etiquette.md)\] , or see [existing discussions](https://lists.sr.ht/~skeeto/public-inbox?search=Pen+and+Paper+RPG+Wishlist).
