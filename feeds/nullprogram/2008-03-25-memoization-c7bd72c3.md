---
title: Memoization
url: https://nullprogram.com/blog/2008/03/25/
published: "2008-03-25T00:00:00Z"
feed: nullprogram
guid: https://nullprogram.com/blog/2008/03/25/
---
...
I had written in [a
previous post](/blog/2008/01/29#collatz) about a neat feature of Lua. I found out later that this is simply a form of [Memoization](http://en.wikipedia.org/wiki/Memoization). The idea is that you trade memory for speed by only doing calculations once and keeping track of previously calculated values. I had even complained about Perl hashes not being flexible enough (not true, thanks to [Tie::Hash](http://perldoc.perl.org/Tie/Hash.html)). Perl actually has something even cooler, which is the [Memoize
module](http://search.cpan.org/~mjd/Memoize-1.01/Memoize.pm).
...
Have a comment on this article? Start a discussion in my [public inbox](https://lists.sr.ht/~skeeto/public-inbox) by sending an email to [~skeeto/public-inbox@lists.sr.ht](mailto:~skeeto/public-inbox@lists.sr.ht?Subject=Re%3A%20Memoization) \[ [mailing list etiquette](https://man.sr.ht/lists.sr.ht/etiquette.md)\] , or see [existing discussions](https://lists.sr.ht/~skeeto/public-inbox?search=Memoization).
