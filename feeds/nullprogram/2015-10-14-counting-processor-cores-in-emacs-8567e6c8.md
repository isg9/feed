...
url: https://nullprogram.com/blog/2015/10/14/
published: "2015-10-14T00:00:00Z"
feed: nullprogram
guid: https://nullprogram.com/blog/2015/10/14/
---
...
nullprogram.com/blog/2015/10/14/
...
I recently helped a co-worker set this set up for himself, so it had me thinking about the problem again. The situation [in my
config](https://github.com/skeeto/.emacs.d) is much more complicated than it needs to be, so I’ll share a simplified version instead.
...
It traverses up (down?) the directory hierarchy towards root looking for a Makefile — or whatever is set for `quick-compile-build-file` — then invokes the build system there. I [don’t believe in recursive
`make`](http://aegis.sourceforge.net/auug97.pdf).
...
Have a comment on this article? Start a discussion in my [public inbox](https://lists.sr.ht/~skeeto/public-inbox) by sending an email to [~skeeto/public-inbox@lists.sr.ht](mailto:~skeeto/public-inbox@lists.sr.ht?Subject=Re%3A%20Counting%20Processor%20Cores%20in%20Emacs) \[ [mailing list etiquette](https://man.sr.ht/lists.sr.ht/etiquette.md)\] , or see [existing discussions](https://lists.sr.ht/~skeeto/public-inbox?search=Counting+Processor+Cores+in+Emacs).
