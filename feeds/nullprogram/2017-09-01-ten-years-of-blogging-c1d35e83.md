...
url: https://nullprogram.com/blog/2017/09/01/
published: "2017-09-01T00:00:00Z"
feed: nullprogram
guid: https://nullprogram.com/blog/2017/09/01/
---

# Ten Years of Blogging

## [Ten Years of Blogging](/blog/2017/09/01/)

September 01, 2017

nullprogram.com/blog/2017/09/01/

As of today, I’ve been blogging for 10 years. In this time I’ve written 302,000 words across [343 articles](/index/) — a rate of one article every week and a half. These articles form a record of my professional progress, touching on both “hard” technical skills and “soft” communication skills. My older articles are a personal reminder of how far I’ve come. They are proof that I’m not as stagnant as I sometimes feel, and it helps me to sympathize with others who are currently in those earlier stages of their own career.
...
Before blogging, I had a simple Penn State student page showcasing a few small — and, in retrospect, trivial — side projects ( [1](https://github.com/skeeto/pngarch), [2](https://github.com/skeeto/binitools), [3](https://github.com/skeeto/mandelbrot)), none of which went anywhere. Around the beginning of my final semester of college, I was inspired by Mark Dominus’ [The
Universe of Discourse](https://blog.plover.com/) and Andy Owen’s [Friendly Robot
Overlord](http://web.archive.org/web/20110608003905/http://ultra-premium.com/b/) (gone since 2011) to start my own [blosxom](http://blosxom.sourceforge.net/) blog. It would be an outlet to actively discuss my projects. Some time later GitHub was founded, and I [switched to a static blog](/blog/2011/08/05/) hosted by [GitHub Pages](https://pages.github.com/), which is where it lives to this day.

It’s been more challenging to manage all this content than I ever anticipated. It’s like maintaining a large piece of software, except it’s naturally more fragile. Any time I make a non-trivial change to the CSS, I have to inspect the archives to check if I broke older articles. If I did, sometimes it’s a matter of further adjusting the CSS. Other times I’ll mass edit a couple hundred articles in order to normalize some particular aspect, such as heading consistency or image usage. (Running a macro over an Emacs’ [Dired](https://www.gnu.org/software/emacs/manual/html_node/emacs/Dired.html) buffer is great for this.)
...
With more foresight and experience, I could have laid down better conventions for myself from the beginning. Besides the universal impossibility of already having experience before it’s needed, there’s also the issue that the internet’s conventions have changed, too. This blog is currently built with HTML5, but this wasn’t always the case — especially considering that predates HTML5. When [I switched to
HTML5](/blog/2009/06/30/), I also adjusted some of my own conventions to match, since, at the time, I was still writing articles in raw HTML.
...
[URLs are forever](https://www.w3.org/Provider/Style/URI), and I don’t want to break all my old links. Consistency is better than any sort of correction. I’m also practically limited to one article per day, though this has never been a real problem.
...
Third, after [three years of teaching](/blog/2016/09/02/), it seems like it’s becoming more difficult to put myself in the student’s shoes. I’m increasingly further away from my own days learning those early topics, and it’s harder to remember the limitations of my knowledge at that time. Having this blog really helps, and I’ve re-read some of my older articles to recall my mindset at the time.
...
Let’s broaden the scope to academic papers. Thanks to some great co-workers — all three of whom are smarter and handsomer than me — a year ago I finally got a published academic paper under my belt (and more to come): [*ROP Gadget Prevalence and Survival under*
*Compiler-based Binary Diversification Schemes*](https://skeeto.s3.amazonaws.com/share/p15-coffman.pdf) (and I said *memos* were dry!). A ton of work went into this paper, and it’s far more substantial than any memo or single blog post. The process was a lot more pleasant (LaTeX instead of Word), and the results are definitely much more polished than a typical blog post. It reads well and has interesting information to present.
...
- July 2017: [Rolling Shutter Simulation in C](/blog/2017/07/02/)
  - 10,400 unique visitors
  - #22 most popular
- August 2017: [A Tutorial on Portable Makefiles](/blog/2017/08/20/)
  - 14,300 unique visitors
  - #16 most popular
- June 2017: [Switching to the Mutt Email Client](/blog/2017/06/15/)
  - 23,100 unique visitors
  - #5 most popular
- May 2015: [Raw Linux Threads via System Calls](/blog/2015/05/15/)
...
3. Even more, this entire blog is in the public domain. If you don’t believe me, check out the public domain dedication in the footer of this page. It’s been there for years, and you can [verify that
   yourself](https://github.com/skeeto/skeeto.github.com). Every single change to this blog in the past 6 years has been publicly documented ( *transparency*).
...
In 2017, a blog is by far the most effective way to publish and share written information, and [have more scientific quality than
journals](http://daniellakens.blogspot.com/2017/04/five-reasons-blog-posts-are-of-higher.html). More people should be publishing through blog articles than traditional forms of publications, which are far less effective.
...
Have a comment on this article? Start a discussion in my [public inbox](https://lists.sr.ht/~skeeto/public-inbox) by sending an email to [~skeeto/public-inbox@lists.sr.ht](mailto:~skeeto/public-inbox@lists.sr.ht?Subject=Re%3A%20Ten%20Years%20of%20Blogging) \[ [mailing list etiquette](https://man.sr.ht/lists.sr.ht/etiquette.md)\] , or see [existing discussions](https://lists.sr.ht/~skeeto/public-inbox?search=Ten+Years+of+Blogging).

« [Vim vs. Emacs: the Working Directory](/blog/2017/08/22/)
