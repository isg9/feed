...
url: https://nullprogram.com/blog/2007/09/02/
published: "2007-09-02T00:00:00Z"
feed: nullprogram
guid: https://nullprogram.com/blog/2007/09/02/
---
...
nullprogram.com/blog/2007/09/02/

In preparation for another project idea I have (to be posted in the future), I wrote a [Mandelbrot](http://en.wikipedia.org/wiki/Mandelbrot_set) fractal generator in [Octave](http://www.octave.org). Octave is great for just trying things out and prototyping your algorithms. It is very slow, however. Here is the code,
...
You may need to comment out the `waitbar` line if you do not have [Octave-Forge](http://octave.sourceforge.net/) installed properly (as is the case with Octave 2.9 on Debian as of this writing) or at all. You will also need Octave-Forge if you want to use the image functions described below. ( *This information is out of date.*)
...
Have a comment on this article? Start a discussion in my [public inbox](https://lists.sr.ht/~skeeto/public-inbox) by sending an email to [~skeeto/public-inbox@lists.sr.ht](mailto:~skeeto/public-inbox@lists.sr.ht?Subject=Re%3A%20Mandelbrot%20with%20GNU%20Octave) \[ [mailing list etiquette](https://man.sr.ht/lists.sr.ht/etiquette.md)\] , or see [existing discussions](https://lists.sr.ht/~skeeto/public-inbox?search=Mandelbrot+with+GNU+Octave).

« [null program is Alive](/blog/2007/09/01/)
