...
url: https://nullprogram.com/blog/2016/10/07/
published: "2016-10-07T00:00:00Z"
feed: nullprogram
guid: https://nullprogram.com/blog/2016/10/07/
---
...
- [Tuning C++: Benchmarks, and CPUs, and Compilers! Oh My!](https://www.youtube.com/watch?v=nXaxk27zwlk) (2015)
- [High Performance Code 201: Hybrid Data Structures](https://www.youtube.com/watch?v=vElZc6zSIXM) (2016)
- [Understanding Compiler Optimization](https://www.youtube.com/watch?v=FnGCDLhaxKU) (2015)
- [Optimizing the Emergent Structures of C++](https://www.youtube.com/watch?v=eR34r7HOU14) (2013)

After writing this article, I saw Nicholas Ormrod’s talk, [The strange
details of std::string at Facebook](https://www.youtube.com/watch?v=kPR8h4-qZdk), which is also highly relevant.
...
And finally, cleaning up. I hadn’t thought about this before, but if the compiler manages to inline vec\_simple\_free(), that NULL pointer assignment will probably get optimized out, possibly [even in the face
of a use-after-free bug](http://blog.llvm.org/2011/05/what-every-c-programmer-should-know.html).
...
Have a comment on this article? Start a discussion in my [public inbox](https://lists.sr.ht/~skeeto/public-inbox) by sending an email to [~skeeto/public-inbox@lists.sr.ht](mailto:~skeeto/public-inbox@lists.sr.ht?Subject=Re%3A%20Small-Size%20Optimization%20in%20C) \[ [mailing list etiquette](https://man.sr.ht/lists.sr.ht/etiquette.md)\] , or see [existing discussions](https://lists.sr.ht/~skeeto/public-inbox?search=Small-Size+Optimization+in+C).
