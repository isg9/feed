...
url: https://nullprogram.com/blog/2021/03/11/
published: "2021-03-11T00:00:00Z"
feed: nullprogram
guid: https://nullprogram.com/blog/2021/03/11/
---

# A guide to Windows application development using w64devkit

## [A guide to Windows application development using w64devkit](/blog/2021/03/11/)

March 11, 2021

nullprogram.com/blog/2021/03/11/

There’s a trend of building services where a monolithic application is better suited, or using JavaScript and Python then being stumped by their troublesome deployment story. This leads to solutions like [bundling an
entire web browser](https://deftly.net/posts/2017-06-01-measuring-the-weight-of-an-electron.html) with an application, or using containers to circumscribe [a sprawling dependency tree made of mystery meat](https://research.swtch.com/deps).

My [small development distribution](/blog/2020/05/15/) for Windows, [w64devkit](https://github.com/skeeto/w64devkit), is my own little way of pushing back against this trend where it affects me most. Following in the footsteps of projects like [Handmade Hero](https://handmadehero.org/) and [Making a Video Game from Scratch](https://www.youtube.com/playlist?list=PLlaINRtydtNWuRfd4Ra3KeD6L9FP_tDE7), this is my guide to no-nonsense software development using my development kit. It’s an overview of the tooling and development workflow, and I’ve tried not to assume too much knowledge of the reader. Being a guide rather than manual, it is incomplete on its own, and I link to substantial external resources to fill in the gaps. The guide is capped with a small game I wrote entirely using my development kit, serving as a demonstration of what sorts of things are not only possible, but quite reasonably attainable.

Game repository: [https://github.com/skeeto/asteroids-demo](https://github.com/skeeto/asteroids-demo)

Guide to source: [Understanding Asteroids](https://idle.nprescott.com/2021/understanding-asteroids.html)

### Initial setup

Of course you cannot use the development kit if you don’t have it yet. Go to the [releases section](https://github.com/skeeto/w64devkit/releases) and download the latest release. It will be a .zip file named `w64devkit-x.y.z.zip` where `x.y.z` is the version.
...
originally a *shell* around the operating system kernel](https://www.youtube.com/watch?v=tc4ROCJYbm0&t=4m57s) — the user interface to the kernel. Your system’s graphical interface — Windows Explorer, or `Explorer.exe` — is really just a kind of shell, too. That shell is oriented around the mouse and graphics. This is fine for some tasks, but a keyboard-oriented command shell is far better suited for development tasks. It’s more efficient, but more importantly its features are composable: Complex operations and processes can be [constructed
from](https://www.youtube.com/watch?v=bKzonnwoR2I) simple, easy-to-understand tools. Embrace it!
...
language specification](https://pubs.opengroup.org/onlinepubs/9699919799/utilities/V3_chap02.html) is a good reference. All of the features listed in that document are available to your shell scripts.

### Text editing

The development kit includes the powerful and popular text editor [Vim](https://www.vim.org/). It takes effort to learn, but is well worth the investment. It’s packed with features, but since you only need a small number of them on a regular basis it’s not as daunting as it might appear. Using Vim effectively, you will write and edit text so much more quickly than before. That includes not just code, but prose: READMEs, documentation, etc.
...
Once you’re comfortable with the basics, the best next step is to read [*Practical Vim: Edit Text at the Speed of Thought*](https://pragprog.com/titles/dnvim2/practical-vim-second-edition/) by Drew Neil. It’s an opinionated guide to Vim that instills good habits. If you want something cost-free to whet your appetite, check out [*Seven habits of*
...
From here you can set breakpoints and such, then run the program with `start` or `run`, then `step` through it line by line. See [*Beej’s Quick*
*Guide to GDB*](https://beej.us/guide/bggdb/) for a guide. During development, always run your program through GDB, and never exit GDB. See also: [*Assertions should be*
*more debugger-oriented*](/blog/2022/06/26/).

#### Learning C and C++

So far this guide hasn’t actually assumed any C knowledge. One of the best ways to learn C is by reading the highly-regarded [*The C Programming*
*Language*](https://en.wikipedia.org/wiki/The_C_Programming_Language) and doing the exercises. Alternatively, cost-free options are [*Beej’s Guide to C Programming*](http://beej.us/guide/bgc/) and [*Modern C*](https://modernc.gforge.inria.fr/) (more advanced). You can use the development kit to go through any of these.

I’ve focused on C, but everything above also applies to C++. To learn C++ [*A Tour of C++*](https://www.stroustrup.com/tour2.html) is a safe bet.

### Demonstration

To illustrate how much you can do with nothing beyond than this 76MB development kit, here’s a taste in the form of a weekend project: an [Asteroids Clone for Windows](https://github.com/skeeto/asteroids-demo). That’s the game in the video at the top of this guide.

The development kit doesn’t include Git so you’d need to install it separately in order to clone the repository, but you could at least skip that and download a .zip snapshot of the source. It has no third-party dependencies yet it includes hardware-accelerated graphics, real-time sound mixing, and gamepad input. Building a larger and more complex game is much less about tooling and more about time and skill. That’s what I mean about w64devkit being [(almost) everything you need](/blog/2020/09/25/).

- [c](/tags/c/)
- [cpp](/tags/cpp/)
- [win32](/tags/win32/)

Have a comment on this article? Start a discussion in my [public inbox](https://lists.sr.ht/~skeeto/public-inbox) by sending an email to [~skeeto/public-inbox@lists.sr.ht](mailto:~skeeto/public-inbox@lists.sr.ht?Subject=Re%3A%20A%20guide%20to%20Windows%20application%20development%20using%20w64devkit) \[ [mailing list etiquette](https://man.sr.ht/lists.sr.ht/etiquette.md)\] , or see [existing discussions](https://lists.sr.ht/~skeeto/public-inbox?search=A+guide+to+Windows+application+development+using+w64devkit).

« [Well-behaved alias commands on Windows](/blog/2021/02/08/)
