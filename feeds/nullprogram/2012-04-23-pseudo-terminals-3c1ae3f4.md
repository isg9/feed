...
url: https://nullprogram.com/blog/2012/04/23/
published: "2012-04-23T00:00:00Z"
feed: nullprogram
guid: https://nullprogram.com/blog/2012/04/23/
---
...
nullprogram.com/blog/2012/04/23/
...
The printed device name can be opened by software that’s expecting to access a serial port, such as [minicom](http://en.wikipedia.org/wiki/Minicom), and it can be communicated with as if by a pipe. This could be useful in testing a program’s serial port communication logic virtually.
...
Have a comment on this article? Start a discussion in my [public inbox](https://lists.sr.ht/~skeeto/public-inbox) by sending an email to [~skeeto/public-inbox@lists.sr.ht](mailto:~skeeto/public-inbox@lists.sr.ht?Subject=Re%3A%20Pseudo-terminals) \[ [mailing list etiquette](https://man.sr.ht/lists.sr.ht/etiquette.md)\] , or see [existing discussions](https://lists.sr.ht/~skeeto/public-inbox?search=Pseudo-terminals).
