...
url: https://nullprogram.com/blog/2013/09/04/
published: "2013-09-04T00:00:00Z"
feed: nullprogram
guid: https://nullprogram.com/blog/2013/09/04/
---
...
nullprogram.com/blog/2013/09/04/

Unsatisfied with my the results of [recent search for a new web feed reader](/blog/2013/06/13/), I created my own from scratch, called [Elfeed](https://github.com/skeeto/elfeed). It’s built on top of Emacs and is available for download through [MELPA](http://melpa.milkbox.net/). I intend it to be highly extensible, a power user’s web feed reader. It supports both Atom and RSS.

- [https://github.com/skeeto/elfeed](https://github.com/skeeto/elfeed)

The design of Elfeed was inspired by [notmuch](http://notmuchmail.org/), which is [my e-mail client of choice](/blog/2013/09/03/). I’ve enjoyed the notmuch search interface and the extensibility of the whole system — a side-effect of being written in Emacs Lisp — so much that I wanted a similar interface for my web feed reader.
...
Everything fetched will be added to the database for next time you run Emacs. It’s not required at all in order to use Elfeed, but I’ll discuss some of [the details of the database format in another post](/blog/2013/09/09/).
...
Have a comment on this article? Start a discussion in my [public inbox](https://lists.sr.ht/~skeeto/public-inbox) by sending an email to [~skeeto/public-inbox@lists.sr.ht](mailto:~skeeto/public-inbox@lists.sr.ht?Subject=Re%3A%20Introducing%20Elfeed,%20an%20Emacs%20Web%20Feed%20Reader) \[ [mailing list etiquette](https://man.sr.ht/lists.sr.ht/etiquette.md)\] , or see [existing discussions](https://lists.sr.ht/~skeeto/public-inbox?search=Introducing+Elfeed%2C+an+Emacs+Web+Feed+Reader).
