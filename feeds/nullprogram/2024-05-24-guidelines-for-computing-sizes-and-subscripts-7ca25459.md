...
url: https://nullprogram.com/blog/2024/05/24/
published: "2024-05-24T00:00:00Z"
feed: nullprogram
guid: https://nullprogram.com/blog/2024/05/24/
---
...
6. Do not subtract unless you know *a priori* both signed operands are non-negative. For unsigned, that the second operand is not larger than the first (treat it like (4)).
...
In pointer arithmetic addition, it’s a common mistake to compute the result pointer then compare it to the bounds. If the check failed, then the pointer *already* overflowed, i.e. undefined behavior. Major pieces software, [like glibc](https://sourcegraph.com/search?q=context:global+%22%3E+outend%22+repo:%5Egithub%5C.com/bminor/glibc%24+&patternType=keyword&sm=0), are riddled with such pointer overflows. (Now that you’re aware of it, you’ll start noticing it everywhere. Sorry.)
...
Have a comment on this article? Start a discussion in my [public inbox](https://lists.sr.ht/~skeeto/public-inbox) by sending an email to [~skeeto/public-inbox@lists.sr.ht](mailto:~skeeto/public-inbox@lists.sr.ht?Subject=Re%3A%20Guidelines%20for%20computing%20sizes%20and%20subscripts) \[ [mailing list etiquette](https://man.sr.ht/lists.sr.ht/etiquette.md)\] , or see [existing discussions](https://lists.sr.ht/~skeeto/public-inbox?search=Guidelines+for+computing+sizes+and+subscripts).
