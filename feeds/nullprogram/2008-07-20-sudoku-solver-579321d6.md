---
title: Sudoku Solver
url: https://nullprogram.com/blog/2008/07/20/
published: "2008-07-20T00:00:00Z"
feed: nullprogram
guid: https://nullprogram.com/blog/2008/07/20/
---
...
While I was in there I saw a large book of [Sudoku](http://en.wikipedia.org/wiki/Sudoku) puzzles. Since the toilet is a good spot to think (I like to call it my " [thinking chair](http://everything-more.blogspot.com/2008/04/that-t-shirt-is-wrong-color.html)"), I thought out an algorithm for solving Sudokus. I then left the bathroom and implemented it in order to verify that it worked.
...
![Worst-case Sudoku](/img/sudoku/worst-case.png)
...
Have a comment on this article? Start a discussion in my [public inbox](https://lists.sr.ht/~skeeto/public-inbox) by sending an email to [~skeeto/public-inbox@lists.sr.ht](mailto:~skeeto/public-inbox@lists.sr.ht?Subject=Re%3A%20Sudoku%20Solver) \[ [mailing list etiquette](https://man.sr.ht/lists.sr.ht/etiquette.md)\] , or see [existing discussions](https://lists.sr.ht/~skeeto/public-inbox?search=Sudoku+Solver).
