...
feed: nullprogram
guid: https://nullprogram.com/blog/2018/11/21/
---
...
*This article was [discussed on Hacker News](https://news.ycombinator.com/item?id=18504879).*

Most widely-used programming languages have at least one regular conference dedicated to discussing it. Heck, even [Lisp has
one](https://www.european-lisp-symposium.org/). It’s a place to talk about the latest developments of the language, recent and upcoming standards, and so on. However, C is a notable exception. Despite [its role as the foundation](https://skeeto.s3.amazonaws.com/share/onward17-essays2.pdf) of the entire software ecosystem, there aren’t any regular conferences about C. I have a couple of theories about why.
...
Have a comment on this article? Start a discussion in my [public inbox](https://lists.sr.ht/~skeeto/public-inbox) by sending an email to [~skeeto/public-inbox@lists.sr.ht](mailto:~skeeto/public-inbox@lists.sr.ht?Subject=Re%3A%20Why%20Aren't%20There%20C%20Conferences?) \[ [mailing list etiquette](https://man.sr.ht/lists.sr.ht/etiquette.md)\] , or see [existing discussions](https://lists.sr.ht/~skeeto/public-inbox?search=Why+Aren%27t+There+C+Conferences%3F).
