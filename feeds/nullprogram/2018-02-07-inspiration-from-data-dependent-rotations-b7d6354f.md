...
url: https://nullprogram.com/blog/2018/02/07/
published: "2018-02-07T00:00:00Z"
feed: nullprogram
guid: https://nullprogram.com/blog/2018/02/07/
---
...
This article is an expanded email I wrote in response to a question from Frank Muller. He asked how I arrived at my solution to a [branchless UTF-8 decoder](/blog/2017/10/06/):
...
the Blowfish cipher](/blog/2017/09/15/) and [a 64-bit PRNG shootout](/blog/2017/09/21/). My layman’s study of Blowfish was actually part of an examination of a number of different block ciphers. For example, I also read the NSA’s [Speck and Simon paper](http://eprint.iacr.org/2013/404.pdf) and then [implemented the 128/128 variant
of Speck](https://github.com/skeeto/scratch/tree/master/speck) — a 128-bit key and 128-bit block. I didn’t take the time to write an article about it, but note how the entire cipher — key schedule, encryption, and decryption — is just 40 lines of code:
...
Another cipher I studied, though in less depth, was [RC5](http://people.csail.mit.edu/rivest/Rivest-rc5rev.pdf) (1994), a block cipher by (obviously) Ron Rivest. The most novel part of RC5 is its use of data dependent rotations. This was a very deliberate decision, and the paper makes this clear:
...
PRNGs](http://www.pcg-random.org/). Honestly, the data-dependent “permutation” shift is *the* defining characteristic of PCG. As a reminder, here’s the simplified PCG from my shootout:
...
I think this raises a really interesting question: Why did it take until 2014 for someone to apply a data-dependent shift to a PRNG? Similarly, why are [data-dependent rotations not used in many ciphers](https://crypto.stackexchange.com/q/20325)?
...
It turns out there are also some patent issues (ex. [1](https://www.google.com/patents/US5724428), [2](https://www.google.com/patents/US6269163)). Fortunately most of these patents have now expired, and one in particular is set to expire this June. I still like my theory better.
...
Have a comment on this article? Start a discussion in my [public inbox](https://lists.sr.ht/~skeeto/public-inbox) by sending an email to [~skeeto/public-inbox@lists.sr.ht](mailto:~skeeto/public-inbox@lists.sr.ht?Subject=Re%3A%20Inspiration%20from%20Data-dependent%20Rotations) \[ [mailing list etiquette](https://man.sr.ht/lists.sr.ht/etiquette.md)\] , or see [existing discussions](https://lists.sr.ht/~skeeto/public-inbox?search=Inspiration+from+Data-dependent+Rotations).
