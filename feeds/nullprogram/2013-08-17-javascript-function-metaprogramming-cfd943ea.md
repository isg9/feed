...
url: https://nullprogram.com/blog/2013/08/17/
published: "2013-08-17T00:00:00Z"
feed: nullprogram
guid: https://nullprogram.com/blog/2013/08/17/
---
...
nullprogram.com/blog/2013/08/17/

The [JavaScript Function constructor](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function) is useful metaprogramming feature of JavaScript. It works like `eval`, treating the contents of a string as code, but [without the quirkiness](/blog/2012/11/14/). The constructor’s API looks like this,
...
The primary flaw with the Function constructor is that it’s variadic. The whole purpose of this constructor is to dynamically generate functions at run-time, but **there’s (generally) no straightforward way** **to call a constructor with a variable number of arguments**. The [`apply` method can’t directly compose with `new`](/blog/2013/03/24/).
