---
title: BCCD Clusters
url: https://nullprogram.com/blog/2007/09/17/
published: "2007-09-17T00:00:00Z"
feed: nullprogram
guid: https://nullprogram.com/blog/2007/09/17/
---
...
A live CD was the obvious choice (and still is) to begin clustering: no installation and quick setup. I started with [dyne:bolic](http://www.dynebolic.org/), a GNU/Linux distribution geared for editing and creating multimedia while strictly using free software (already off to a great start!). I had read that dyne:bolic had clustering capabilities with [openMosix](http://openmosix.sourceforge.net/), which was my reason for looking at it in the first place. I found out later (after digging deep into documentation a dyne:bolic mirror) that dyne:bolic doesn’t include openMosix anymore. No good for me.

Next I found [BCCD](http://bccd.cs.uni.edu/), a live CD distribution based on [LNX-BBC](http://www.lnx-bbc.com/) the same distribution used by the Free Software Foundation for its business-sized CD member cards. This one is fantastic! I think this is due to its goal as an educational tool, making it easy to learn about clusters while using it. It comes with several programming examples and full MPI development capabilities.
...
Have a comment on this article? Start a discussion in my [public inbox](https://lists.sr.ht/~skeeto/public-inbox) by sending an email to [~skeeto/public-inbox@lists.sr.ht](mailto:~skeeto/public-inbox@lists.sr.ht?Subject=Re%3A%20BCCD%20Clusters) \[ [mailing list etiquette](https://man.sr.ht/lists.sr.ht/etiquette.md)\] , or see [existing discussions](https://lists.sr.ht/~skeeto/public-inbox?search=BCCD+Clusters).
