...
url: https://nullprogram.com/blog/2012/11/20/
published: "2012-11-20T00:00:00Z"
feed: nullprogram
guid: https://nullprogram.com/blog/2012/11/20/
---
...
nullprogram.com/blog/2012/11/20/

After my [last post](/blog/2012/11/19/), [Gavin](http://devrand.org/) sent me this: [Scope Cheatsheet](https://developer.mozilla.org/en-US/docs/JavaScript/Reference/Scope_Cheatsheet). Besides its misleading wording, an interesting fact stood out and gave me another JavaScript challenge question. I’ll also show you how it allows JavaScript to raise the dead!

### Background

Like its close cousin, Scheme, JavaScript is a [Lisp-1](http://en.wikipedia.org/wiki/Common_Lisp#The_function_namespace): functions and variables share the same namespace. In Scheme, the `define` form defines new variables.
...
Have a comment on this article? Start a discussion in my [public inbox](https://lists.sr.ht/~skeeto/public-inbox) by sending an email to [~skeeto/public-inbox@lists.sr.ht](mailto:~skeeto/public-inbox@lists.sr.ht?Subject=Re%3A%20Raising%20the%20Dead%20with%20JavaScript) \[ [mailing list etiquette](https://man.sr.ht/lists.sr.ht/etiquette.md)\] , or see [existing discussions](https://lists.sr.ht/~skeeto/public-inbox?search=Raising+the+Dead+with+JavaScript).
