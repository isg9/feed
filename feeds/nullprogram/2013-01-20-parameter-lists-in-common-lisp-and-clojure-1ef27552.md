...
url: https://nullprogram.com/blog/2013/01/20/
published: "2013-01-20T00:00:00Z"
feed: nullprogram
guid: https://nullprogram.com/blog/2013/01/20/
---
...
As far as *parameters* are concerned, this is all Clojure has. However, Clojure’s parameter specification is actually *more* flexible than Common Lisp’s lambda lists in two important ways. One is that **parameter position can vary with the number of provided** **arguments**. The Clojure core functions use this a lot (ex. [`reduce`](http://clojuredocs.org/clojure_core/1.2.0/clojure.core/reduce)).
...
Have a comment on this article? Start a discussion in my [public inbox](https://lists.sr.ht/~skeeto/public-inbox) by sending an email to [~skeeto/public-inbox@lists.sr.ht](mailto:~skeeto/public-inbox@lists.sr.ht?Subject=Re%3A%20Parameter%20Lists%20in%20Common%20Lisp%20and%20Clojure) \[ [mailing list etiquette](https://man.sr.ht/lists.sr.ht/etiquette.md)\] , or see [existing discussions](https://lists.sr.ht/~skeeto/public-inbox?search=Parameter+Lists+in+Common+Lisp+and+Clojure).
