...
url: https://nullprogram.com/blog/2013/04/28/
published: "2013-04-28T00:00:00Z"
feed: nullprogram
guid: https://nullprogram.com/blog/2013/04/28/
---
...
nullprogram.com/blog/2013/04/28/

There was an interesting Daily Programmer problem posted a couple of weeks ago: [write a userspace threading library](http://redd.it/1ceai7). I decided to do it in JavaScript, building it on top of `setTimeout`. Remember that JavaScript is single-threaded by specification, so this will be a nonpreemptive, cooperative system.
...
Here’s a [simple-httpd](/blog/2012/08/20/) servlet for generating numbers. The route for this servlet will be `/random`.
...
Since I’m doing this interactively with [Skewer](/blog/2012/10/31/) on the blank demo page, make a tag for displaying the number.
...
Have a comment on this article? Start a discussion in my [public inbox](https://lists.sr.ht/~skeeto/public-inbox) by sending an email to [~skeeto/public-inbox@lists.sr.ht](mailto:~skeeto/public-inbox@lists.sr.ht?Subject=Re%3A%20Userspace%20Threading%20in%20JavaScript) \[ [mailing list etiquette](https://man.sr.ht/lists.sr.ht/etiquette.md)\] , or see [existing discussions](https://lists.sr.ht/~skeeto/public-inbox?search=Userspace+Threading+in+JavaScript).
