...
url: https://nullprogram.com/blog/2013/03/11/
published: "2013-03-11T00:00:00Z"
feed: nullprogram
guid: https://nullprogram.com/blog/2013/03/11/
---

# Serializing JavaScript Objects

## [Serializing JavaScript Objects](/blog/2013/03/11/)

March 11, 2013

nullprogram.com/blog/2013/03/11/

This year I’m participating in the annual [Seven Day Roguelike Challenge](http://roguebasin.roguelikedevelopment.org/index.php?title=7DRL), where participants are attempting to create their own fully-playable [roguelike](http://en.wikipedia.org/wiki/Roguelike) within seven days. My entry is called [Disc RL](https://github.com/skeeto/disc-rl) ( [play](/disc-rl/)), a client-side browser roguelike.

Today’s issue was saving the game state in [Local Storage](http://diveintohtml5.info/storage.html). Otherwise the entire game would be lost if the tab was closed or the page left for any reason. This would limit the possible depth of my game, as any time investment could easily be lost. The issue is that Local Storage only stores strings, so the game state must be serialized and deserialized by my application.
...
Have a comment on this article? Start a discussion in my [public inbox](https://lists.sr.ht/~skeeto/public-inbox) by sending an email to [~skeeto/public-inbox@lists.sr.ht](mailto:~skeeto/public-inbox@lists.sr.ht?Subject=Re%3A%20Serializing%20JavaScript%20Objects) \[ [mailing list etiquette](https://man.sr.ht/lists.sr.ht/etiquette.md)\] , or see [existing discussions](https://lists.sr.ht/~skeeto/public-inbox?search=Serializing+JavaScript+Objects).
