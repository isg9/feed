...
url: https://nullprogram.com/blog/2007/10/08/
published: "2007-10-08T00:00:00Z"
feed: nullprogram
guid: https://nullprogram.com/blog/2007/10/08/
---
...
*Update 2009-07-07: I use Java all the time at work now. There is* *really no escaping it. Except maybe with something like* *[Clojure](http://clojure.org/) …*

- [java](/tags/java/)
- [interactive](/tags/interactive/)

Have a comment on this article? Start a discussion in my [public inbox](https://lists.sr.ht/~skeeto/public-inbox) by sending an email to [~skeeto/public-inbox@lists.sr.ht](mailto:~skeeto/public-inbox@lists.sr.ht?Subject=Re%3A%20Java%20Animated%20Maze%20Generator%20and%20Solver) \[ [mailing list etiquette](https://man.sr.ht/lists.sr.ht/etiquette.md)\] , or see [existing discussions](https://lists.sr.ht/~skeeto/public-inbox?search=Java+Animated+Maze+Generator+and+Solver).
