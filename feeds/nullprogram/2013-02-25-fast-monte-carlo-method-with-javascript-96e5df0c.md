...
url: https://nullprogram.com/blog/2013/02/25/
published: "2013-02-25T00:00:00Z"
feed: nullprogram
guid: https://nullprogram.com/blog/2013/02/25/
---
...
nullprogram.com/blog/2013/02/25/
...
[The answer](http://bayesianthink.blogspot.com/2013/02/the-expected-draws-to-sum-over-one.html) is *e*. When I came across this question I took the lazy programmer route and, rather than work out the math, I estimated the answer using the Monte Carlo method. I used the language I always use for these scratchpad computations: Emacs Lisp. All I need to do is switch to the `*scratch*` buffer and start hacking. No external program needed.
...
Even though Elisp was fast enough to determine that the answer is probably *e*, I wanted to play around with it. This little test program doubles as a way to estimate the value of *e*, [similar to estimating *pi*](http://math.fullerton.edu/mathews/n2003/montecarlopimod.html). The more trial runs I give it the more accurate my answer will get — to a point.
...
Have a comment on this article? Start a discussion in my [public inbox](https://lists.sr.ht/~skeeto/public-inbox) by sending an email to [~skeeto/public-inbox@lists.sr.ht](mailto:~skeeto/public-inbox@lists.sr.ht?Subject=Re%3A%20Fast%20Monte%20Carlo%20Method%20with%20JavaScript) \[ [mailing list etiquette](https://man.sr.ht/lists.sr.ht/etiquette.md)\] , or see [existing discussions](https://lists.sr.ht/~skeeto/public-inbox?search=Fast+Monte+Carlo+Method+with+JavaScript).
