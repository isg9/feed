---
title: Undergraduate programming
url: https://www.joelonsoftware.com/2008/01/08/undergraduate-programming/
published: "2008-01-08T00:11:33Z"
feed: joel
guid: https://www.joelonsoftware.com/?p=692
---

# Undergraduate programming

From [CrossTalk, The Journal of Defense Software Engineering](http://www.stsc.hill.af.mil/CrossTalk/2008/01/0801DewarSchonberg.html): “It is our view that Computer Science (CS) education is neglecting basic skills, in particular in the areas of programming and formal methods. We consider that the general adoption of Java as a first programming language is in part responsible for this decline.”

[![](https://i0.wp.com/www.joelonsoftware.com/wp-content/uploads/2008/01/Lincoln_Center_Trees.jpg?resize=280%2C192&ssl=1)JavaSchools](https://www.joelonsoftware.com/articles/ThePerilsofJavaSchools.html) are not operating in a vacuum: they’re dumbing down their curriculum because they think it’s the only way to keep CS students. The real problem is that these schools are not doing anything positive to attract the kids who are really interesting in *programming*, not computer science. I think the solution would be to create a programming-intensive BFA in Software Development–a Julliard for programmers. Such a program would consist of a practical studio requirement developing significant works of software on teams with very experienced teachers, with a sprinkling of liberal arts classes for balance. It would be a huge magnet to the talented high school kids who love programming, but can’t get excited about proving theorums.
...
There are already several programs going in this direction: a lot of Canadian universities, notably [Waterloo](http://www.softeng.uwaterloo.ca/), have Software Engineering programs, and in Indiana, [Rose-Hulman](http://www.cs.rose-hulman.edu/) combines a good software engineering program with a co-op program called [Rose-Hulman Ventures](http://www.rhventures.org/). These programs have no problem attracting lots of qualified students at a time when the Ivy League CS departments consider themselves lucky if they get a dozen majors a year.
