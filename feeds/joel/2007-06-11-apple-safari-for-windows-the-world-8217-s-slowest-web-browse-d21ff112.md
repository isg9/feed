...
This is the company that’s about to release the iPhone on a slow, last-generation data network but is running [TV ads](http://www.apple.com/iphone/ads/ad3/) that have edited out all downloads and waiting time that network entails.
...
PPS Yes, I know it’s a beta. Eventually, the Safari programmers will figure out the preloading tricks that IE and Firefox use to get quick startup time (at the cost of slow Windows startup; [Raymond Chen explains it here](http://blogs.msdn.com/oldnewthing/archive/2005/03/11/394249.aspx)). In the meantime, when Apple’s marketing team goes around making untrue claims about performance, they make the company look like liars, not innovators.

PPPS Safari even managed to bring the [inferior font rendering](http://www.codinghorror.com/blog/archives/000884.html) of the OS X platform to Windows, no easy trick.
