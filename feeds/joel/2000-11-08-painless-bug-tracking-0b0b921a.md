...
published: "2000-11-08T00:14:56Z"
feed: joel
guid: https://www.joelonsoftware.com/?p=895
---
...
**ID**1203**Project**Bee Flogger 2.0  **Area**FTP Client**Title****Uploading file causes FTP server to dump core****Assigned To**CLOSED**Status**CLOSED (RESOLVED – FIXED)**Priority**2 – Must Fix**Fix For**2.0 Alpha**Version**Build 2019**Computer**Jill’s iMac, Mac OS 9.0, 128M RAM, 1024×768 millions of colors**Description****11/1/2000 Opened by Jill the Very, Very Good Tester**
