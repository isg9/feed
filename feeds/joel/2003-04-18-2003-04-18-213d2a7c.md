...
published: "2003-04-18T00:04:50Z"
feed: joel
guid: https://www.joelonsoftware.com/?p=289
---

# 2003/04/18

Bob at [Wise Solutions](http://www.wise.com) emailed to remind me that the [Wise Installation System](http://www.wise.com/wis.asp) has patching built in, and costs less than InstallShield plus vBuild.

He also pointed out that [Wise for Windows Installer](http://www.wise.com/wfwi.asp) now has a ton of features for server setups: user account creation, IIS administration, and SQL Server administration… basically they implemented my entire wish list from working on the FogBUGZ 3.0 installer. Good work!
...
For now, Michael convinced me to stick with the tried-and-true [Inno Setup](http://www.wintax.nl/isx/) for the next release of CityDesk. The bandwidth savings don’t quite justify the effort of switching installers.
