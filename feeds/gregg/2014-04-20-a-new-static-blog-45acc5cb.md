...
url: https://www.brendangregg.com/blog/2014-04-20/a-new-static-blog.html
published: "2014-04-20T00:00:00Z"
feed: gregg
guid: https://www.brendangregg.com/blog/2014-04-20/a-new-static-blog.html
---
...
I've been having fun playing with [Jekyll](http://jekyllrb.com), a static blog engine. These build HTML files for serving directly, rather than dynamically generating them on-demand (as is often the case) using PHP and MySQL. This blog is powered by Jekyll. (Yes, I know about [Octopress](http://octopress.org/), which can automate this further.)
...
You may know me from prior blogs: [bdgregg.blogspot.com](http://bdgregg.blogspot.com) (2005-6), blogs.sun.com/brendan (2006-2010) which became [blogs.oracle.com/brendan](http://blogs.oracle.com/brendan) after the acquisition, and [dtrace.org/blogs/brendan](http://dtrace.org/blogs/brendan) (2010-2014). If I work on DTrace some more (I'm not [expecting to](http://dtrace.org/blogs/brendan/2014/03/05/a-new-challenge/)), I'll try to share it on the dtrace.org blog as well.

There are plenty of exciting things I'm doing as a senior performance engineer at Netflix, and I hope to share them on the [Netflix tech blog](http://techblog.netflix.com/), especially when it's a collaboration with other Netflix staff.
