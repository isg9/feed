...
url: https://www.brendangregg.com/blog/2025-08-04/when-to-hire-a-computer-performance-engineering-team-2025-part1.html
published: "2025-08-04T00:00:00Z"
feed: gregg
guid: https://www.brendangregg.com/blog/2025-08-04/when-to-hire-a-computer-performance-engineering-team-2025-part1.html
---
...
- **[Netflix](https://www.brendangregg.com/Slides/YOW2018_CloudPerfRCANetflix/)**: *Cloud Performance Root Cause Analysis* \[me, 2018\]
- **[Meta](https://engineering.fb.com/2025/01/21/production-engineering/strobelight-a-profiling-service-built-on-open-source-technology/)**: Strobelight: *A profiling service built on open source technology* \[Jordan Rome, 2025\]
- **[Pinterest](https://engineering.linkedin.com/performance/who-moved-my-99th-percentile-latency)**: *Debugging the One-in-a-Million Failure: Migrating Pinterest’s Search Infrastructure to Kubernetes* \[Samson Hu, et al. 2025\]
- **[LinkedIn](https://engineering.linkedin.com/performance/who-moved-my-99th-percentile-latency)**: *Who moved my 99th percentile latency?* \[Richard Hsu, Cuong Tran, 2015\]
- **[eBay](https://innovation.ebayinc.com/stories/speed-by-a-thousand-cuts/)**: *Speed by a Thousand Cuts* \[Senthil Padmanabhan, 2020\]
- **[Twitter](https://blog.x.com/engineering/en_us/topics/infrastructure/2019/expand-the-edge)**: *#ExpandTheEdge: Making Twitter Faster* \[Todd Segal, Anthony Roberts, 2019\]
- **[Salesforce](https://engineering.salesforce.com/how-salesforce-makes-performance-engineering-work-at-enterprise-scale-8c2c1323e81d/)**: *How Salesforce makes performance engineering work at Enterprise Scale* \[Archana Sethuraman\]
- **[Uber](https://www.uber.com/en-AU/blog/perfinsights)**: *PerfInsights: Detecting Performance Optimization Opportunities in Go Code using Generative AI* \[Lavanya Verma, Ryan Hang, Sung Whang, Joseph Wang\]
- **[Twitch](https://blog.twitch.tv/en/2016/07/05/gos-march-to-low-latency-gc-a6fa96f06eb7/)**: *Go’s march to low-latency GC* \[Rhys Hiltner, 2016\]
- **[Airbnb](https://medium.com/airbnb-engineering/creating-airbnbs-page-performance-score-5f664be0936)**: *Creating Airbnb’s Page Performance Score* \[Andrew Scheuermann, 2021\]
- **[Stripe](https://stripe.com/blog/using-ml-to-detect-and-respond-to-performance-degradations-in-slices-of-stripe-payments)**: *Using ML to detect and respond to performance degradations in slices of Stripe payments* \[Lakshmi Narayan, Lakshmi Narayan, 2025\]
- **[DoorDash](https://careersatdoordash.com/blog/how-doordash-standardized-and-improved-microservices-caching/)**: *How DoorDash Standardized and Improved Microservices Caching* \[Lev Neiman, Jason Fan, 2023\]
- **[Roblox](https://blog.haydz6.com/2020/11/redesigned-highly-scaled-data-store-lower-99th-percentile-latency-100x)**: *How We Redesigned a Highly Scaled Data Store to Lower 99th Percentile Latency 100x* \[Andrew Korytko, 2020\]
- **[Capital One](https://www.capitalone.com/tech/cloud/cost-optimization-best-practices)**: *Driving cloud value through cost optimization & efficiency* \[Jerzy Grzywinski, Brent Segner, 2024\]
