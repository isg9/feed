...
url: https://www.brendangregg.com/blog/2015-03-10/freebsd-flame-graphs.html
published: "2015-03-10T00:00:00Z"
feed: gregg
guid: https://www.brendangregg.com/blog/2015-03-10/freebsd-flame-graphs.html
---
...
The slides are on [slideshare](http://www.slideshare.net/brendangregg/freebsd-2014-flame-graphs):

There was no camera in the room, so I captured the talk from my laptop using screenflow [youtube](https://www.youtube.com/watch?v=fMV1upo88Zw):
...
```
# git clone https://github.com/brendangregg/FlameGraph     # or download zip
# cd FlameGraph
...
Here's an example resulting flame graph ( [SVG](/blog/images/2015/cpu-freebsd02.svg)). Click to zoom:

![](/blog/images/2015/cpu-freebsd02.svg)
...
I had done an epic flame graphs talk at USENIX/LISA 2013 ( [slides](http://www.slideshare.net/brendangregg/blazing-performance-with-flame-graphs), [video](http://www.youtube.com/watch?v=nZfNehCzGdw)) lasting 90 minutes. It was really two talks in one: CPU flame graphs, then other flame graph types. I was thorough and explained everything, but I've since hesitated to encourage people with casual interest to watch a 90 minute video. For the FreeBSD dev summit, I gave a tour of all flame graph types in 50 minutes, and really got stuck into the technical details fast, skipping introductions. It was a lot of fun, and perhaps I should be doing more talks like this.

This [FreeBSD Developer and Vendor Summit](https://wiki.freebsd.org/201411DevAndVendorSummit/) talk was a day after my [performance analysis](http://www.brendangregg.com/blog/2015-03-06/performance-analysis-bsd.html) talk at MeetBSD CA, which I also recommend watching.
