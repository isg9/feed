---
title: Flame Graph Search
url: https://www.brendangregg.com/blog/2015-08-11/flame-graph-search.html
published: "2015-08-11T00:00:00Z"
feed: gregg
guid: https://www.brendangregg.com/blog/2015-08-11/flame-graph-search.html
---
...
Click the "Search" button on the top right and enter "tcp\_send":

![](/blog/images/2015/flamegraph_search.svg)

You can also type Ctrl-F to search after selecting this SVG, or when on the [SVG link](/blog/images/2015/flamegraph_search.svg).

[Flame graphs](https://github.com/brendangregg/FlameGraph) now have search! Under the large tcp\_send() frame on the right we can see a write code-path. But what's those small tcp\_send()s on the left, above a tcp\_ *recv* msg()? Think about why this could happen, then click the highlighted frames to zoom and see why.
...
The number of samples matching the search is shown on the bottom right as a percentage (this excludes vertical overlap). "tcp\_send" was present in 59.3% of samples. I'm reminded of the following quote from [TCP-IP Digest, Vol 1 #6](https://www.rfc-editor.org/rfc/museum/tcp-ip-digest/tcp-ip-digest.v1n6.1) (Nov 1981), by Bill Joy:
...
I had done rxNetty vs Tomcat analysis earlier this year, and needed to quantify functions in the CPU profiles. Flame graphs helped a lot, but it was still a bit time consuming to find and add up disparate frames. A number of us wanted a way to search for terms and get matched percentages, leading to this feature. Thorsten Lorenz had already implemented search last year in his [web flamegraph interface](https://github.com/thlorenz/flamegraph), as it is incredibly useful.
