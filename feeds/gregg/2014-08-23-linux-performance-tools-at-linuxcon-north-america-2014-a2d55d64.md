---
title: Linux Performance Tools at LinuxCon North America 2014
url: https://www.brendangregg.com/blog/2014-08-23/linux-perf-tools-linuxcon-na-2014.html
published: "2014-08-23T00:00:00Z"
feed: gregg
guid: https://www.brendangregg.com/blog/2014-08-23/linux-perf-tools-linuxcon-na-2014.html
---
...
This week I spoke at [LinuxCon North America 2014](http://events.linuxfoundation.org/events/archive/2014/linuxcon-north-america) in Chicago, which was also my first LinuxCon. I really enjoyed the conference, and it was a privilege to take part and contribute. I'll be returning to work with some useful ideas from talks and talking with attendees.

I included my latest Linux performance observability tools diagram, which I keep updated [here](/linuxperf.html):
...
I gave a similar talk two years ago at [SCaLE11x](/linuxperf.html#SCaLE11x), where I covered performance observability tools. This time, I covered observability, benchmarking, and tuning tools, providing a more complete picture of the performance tools landscape. I hope these help you in a similar way, when you move from observability to performing load tests with benchmarks, and finally tuning the system.

I also presented an updated summary on the state of tracing, after my recent discoveries with ftrace, which is able to serve some tracing needs in existing kernels. For more about ftrace, see my lwn.net article [Ftrace: The hidden light switch](http://lwn.net/Articles/608497/), which was made open the same day as my talk.

At one point I included a blank template for observability tools ( [PNG](/Perf/linux_observability_blank.png)):

[![](/Perf/linux_observability_blank.png)](/Perf/linux_observability_blank.png)
...
![](/blog/images/2014/brendan_linuxconna2014.jpg)

*Photo by [Linux Foundation](https://www.flickr.com/photos/linuxfoundation/sets/72157646259218139/)*
