...
url: https://research.swtch.com/vgo-tour
published: "2018-02-20T00:00:00Z"
feed: russcox
guid: https://research.swtch.com/vgo-tour
---
...
# A Tour of Versioned Go (vgo) ( *[Go & Versioning](vgo), Part 2*) Russ Cox February 20, 2018 *research.swtch.com/vgo-tour* Posted on Tuesday, February 20, 2018. [PDF](vgo-tour.pdf)

For me, design means building, tearing down, and building again, over and over. To write the [new versioning proposal](vgo-intro), I built an prototype, `vgo`, to work through many subtle details. This post shows what it’s like to use `vgo`.
