---
title: 'research!rsc: Broken abstractions in Go'
url: https://research.swtch.com/goabstract
published: "2010-03-29T00:00:00Z"
feed: russcox
guid: https://research.swtch.com/goabstract
---

# research!rsc: Broken abstractions in Go
...
# Broken abstractions in Go Russ Cox March 29, 2010 *research.swtch.com/goabstract* Posted on Monday, March 29, 2010.
...
- [Barry Kelly](http://www.blogger.com/profile/10559947643606684495)(March 29, 2010 9:49 AM) It's expressly the job of a compiler to remove abstractions from code. Ultimately it needs to remove all abstractions, until the remaining bitstream is able to signal the hardware to generate the desired effects in the physical world.
...
- [IDisposable](http://www.blogger.com/profile/02275315449689041289)(January 4, 2011 5:30 PM) Why doesn't the go helper runtime.newproc pop the known-to-be function address and arglist byte-size automatically instead of relying on the call-site to pop them? That would turn this:
