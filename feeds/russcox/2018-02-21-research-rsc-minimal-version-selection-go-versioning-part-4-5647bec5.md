---
title: 'research!rsc: Minimal Version Selection (Go & Versioning, Part 4)'
url: https://research.swtch.com/vgo-mvs
published: "2018-02-21T00:00:00Z"
feed: russcox
guid: https://research.swtch.com/vgo-mvs
---
...
# Minimal Version Selection ( *[Go & Versioning](vgo), Part 4*) Russ Cox February 21, 2018 *research.swtch.com/vgo-mvs* Posted on Wednesday, February 21, 2018. [PDF](vgo-mvs.pdf)
...
## [Low-Fidelity Builds](\#low-fidelity_builds)
...
### [Algorithm 1: Construct Build List](\#algorithm_1)
...
### [Algorithm 2. Upgrade All Modules](\#algorithm_2)
...
### [Algorithm R. Compute a Minimal Requirement List](\#algorithm_r)
...
### [Algorithm 3. Upgrade One Module](\#algorithm_3)
...
### [Algorithm 4. Downgrade One Module](\#algorithm_4)
...
## [Excluding Modules](\#excluding_modules)
...
## [Replacing Modules](\#replacing_modules)
...
## [Who Controls Your Build?](\#who_controls_your_build)
...
## [High-Fidelity Builds](\#high-fidelity_builds)
