---
title: 'research!rsc: QArt Codes'
url: https://research.swtch.com/qart
published: "2012-04-12T00:00:00Z"
feed: russcox
guid: https://research.swtch.com/qart
---
...
# QArt Codes Russ Cox April 12, 2012 *research.swtch.com/qart* Posted on Thursday, April 12, 2012.

QR codes are 2-dimensional bar codes that encode arbitrary text strings. A common use of QR codes is to encode URLs so that people can scan a QR code (for example, on an advertising poster, [building roof](https://web.archive.org/web/20120325112316/http://www.brandchannel.com/home/post/QR-Marketing-Google-Maps.aspx), [volleyball bikini](http://www.dailymail.co.uk/femail/article-2023726/Beach-volleyball-stars-sign-deal-advertising-bikini-clad-behinds.html), [belt buckle](http://www.flickr.com/photos/fluidforms/3524861901/), or [airplane banner](https://web.archive.org/web/20120415161005/http://wtfqrcodes.com/post/18551054478/look-in-the-sky-its-a-bird-its-a-plane-its-the)) to load a web site on a cell phone instead of having to “type” in a URL.

QR codes are encoded using [Reed-Solomon error-correcting codes](/field), so that a QR scanner does not have to see every pixel correctly in order to decode the content. The error correction makes it possible to introduce a few errors (fewer than the maximum that the algorithm can fix) in order to make an image. For example, in 2008, [Duncan Robertson](https://web.archive.org/web/20120125013247/http://whomwah.com/2008/03/12/more-fun-with-qr-codes-and-the-bbc-logo/) took a QR code for “http://bbc.co.uk/programmes” (left) and introduced errors in the form of a BBC logo (right):
...
![](qart1.png)![](qart2.png)![](qart3.png)![](qart4.png)

This post explains the math behind making codes like these, which I call QArt codes. I have published the Go programs that generated these codes as [rsc.io/qr/qart](https://github.com/rsc/qr/tree/master/qart) and created a [web site for creating these codes](/qr/draw).
...
![](qart9.png)![](qart10.png)![](qart11.png)
...
![](qart12.png)![](qart13.png)

![](qart14.png)![](qart15.png)

### Further Information

The source code for this post, including the web coder, is at [rsc.io/qr/qart](https://github.com/rsc/qr/tree/master/qart). The coder compiles from Go to WebAssembly and runs entirely in your browser: the images never leave your computer. If you liked this, you might also like [Zip Files All The Way Down](http://research.swtch.com/2010/03/zip-files-all-way-down.html).
