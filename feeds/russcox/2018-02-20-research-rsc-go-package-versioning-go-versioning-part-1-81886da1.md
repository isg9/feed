...
url: https://research.swtch.com/vgo-intro
published: "2018-02-20T00:00:00Z"
feed: russcox
guid: https://research.swtch.com/vgo-intro
---
...
# Go += Package Versioning ( *[Go & Versioning](vgo), Part 1*) Russ Cox February 20, 2018 *research.swtch.com/vgo-intro* Posted on Tuesday, February 20, 2018. [PDF](vgo-intro.pdf)
...
### [Makefiles, `goinstall`, and `go` `get`](\#makefiles_goinstall_and_go_get)
...
### [Versioning and API Stability](\#versioning_and_api_stability)
...
### [Vendoring and Reproducible Builds](\#vendoring_and_reproducible_builds)
...
### [The Import Compatibility Rule](\#import_compatibility_rule)
...
### [Minimal Version Selection](\#minimal_version_selection)
...
### [Defining Go Modules](\#defining_go_modules)
