---
title: 'research!rsc: Traffic Lights and Buridan''s Ass'
url: https://research.swtch.com/buridan
published: "2008-02-06T00:00:00Z"
feed: russcox
guid: https://research.swtch.com/buridan
---

# research!rsc: Traffic Lights and Buridan's Ass
...
# Traffic Lights and Buridan's Ass Russ Cox February 6, 2008 *research.swtch.com/buridan* Posted on Wednesday, February 6, 2008.

[Buridan's ass](http://en.wikipedia.org/wiki/Buridan%27s_ass) is a donkey in a thought experiment proposed by French philosopher Jean Buridan. Placed exactly halfway between two bales of hay, the purely rational, deterministic donkey starves to death trying to decide which to eat: there is no reason to prefer one bale over the other.

Arbiters, electronic circuits that decide whether a particular voltage is a binary 0 or 1, have the same problem: voltages in the middle can force arbitrarily long decision times. This is known as the [arbiter problem](http://dspace.mit.edu/bitstream/1721.1/3346/1/P-2217-29812795.pdf) or [glitch phenomenon](http://research.microsoft.com/users/lamport/pubs/pubs.html#glitch).

Leslie Lamport observed that the arbiter problem also explains human indecisiveness at critical moments. His paper, “ [**Buridan's Principle**](http://research.microsoft.com/users/lamport/pubs/buridan.pdf),” attempts to make the phenomenon known outside of computer science. Lamport [explains the paper's fate](http://research.microsoft.com/users/lamport/pubs/pubs.html#buridan):
