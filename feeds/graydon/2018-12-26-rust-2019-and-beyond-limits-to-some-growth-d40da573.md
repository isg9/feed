...
published: "2018-12-26T21:44:55Z"
feed: graydon
guid: tag:dreamwidth.org,2011-01-04:684470:263429
---
...
I should note that I am speaking only for myself, not anyone else, and not even as a very active participant in Rust anymore. Moreover these suggestions, to a large extent, apply to many projects. Rust is just one case, but one that is currently doing some conscious year-end reflection.

I should also note overall that I'm quite pleased by the trajectory of the Rust project and this suggestion is being made only in the spirit of keeping it healthy and on-track, avoiding some problems I observe developing in it, as a mostly-outsider these days.
...
2. Necessarily-shared technical artifacts, specifically the language definition itself.

3. The strains on people participating in conversations about those artifacts.
...
## Limiting factors and overshoots.
...
4. The **strains on the people** working on the language. Some parts of the project can be delegated, de-synchronized, proceed in parallel with as many hands are available to work on them. Not so the shared technical artifacts. To some extent, many people (and an increasingly-many people) *need* to be involved in *nearly all* changes, and that means that there's a lot of pressure both for everyone in that group-of-many to "keep up" with all the discourse occurring, and for the standard of what it means to "keep up" to gradually creep upwards as both more changes are proposed, and more voices contribute to each discussion.
...
![comment count unavailable](https://www.dreamwidth.org/tools/commentcount?user=graydon2&ditemid=263429) comments
