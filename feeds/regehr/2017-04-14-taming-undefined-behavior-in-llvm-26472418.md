...
published: "2017-04-14T20:15:18Z"
feed: regehr
guid: http://blog.regehr.org/?p=1496
---

# Taming Undefined Behavior in LLVM

Earlier I wrote that [Undefined Behavior != Unsafe Programming](https://blog.regehr.org/archives/1467), a piece intended to convince you that there’s nothing inherently wrong with undefined behavior as long as it isn’t in developer-facing parts of the system.

Today I want to talk about [a new paper about undefined behavior in LLVM](http://www.cs.utah.edu/~regehr/papers/undef-pldi17.pdf) that’s going to be presented in June at [PLDI 2017](http://pldi17.sigplan.org/). I’m an author of this paper, but not the main one. This work isn’t about debating the merits of undefined behavior, its goal is to describe and try to fix some unintended consequences of the design of undefined behavior at the level of LLVM IR.
